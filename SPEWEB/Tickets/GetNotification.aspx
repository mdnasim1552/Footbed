<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="GetNotification.aspx.cs" Inherits="RealERPWEB.Notification.GetNotification" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="input-group input-group-alt">
                                    <asp:TextBox runat="server" ID="txtSrcNotify" Width="100px" CssClass="form-control form-control-sm" placeholder="Search"></asp:TextBox>
