    ...
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Pinovation Tickets";
            }
        }
        ...
        private void Data_Bind()
        {
            ...
            //this.lblaltckcunt.Text = "(" + dt.Rows.Count + ")";
            ////dv.RowFilter = ("taskprogress='" + "99204" + "'");
            //DataTable tblQC = dv.ToTable();
            //this.lblqctckcunt.Text = "(" + tblQC.Rows.Count + ")";
            ...
            //this.lbldntckcunt.Text = "(" + tblComplete.Rows.Count + ")";
