    ...
    public partial class LinkFinncialReports : System.Web.UI.Page
    {
        ...
        protected void GetIncomeStatement()
        {
            ...
            if (ds1.Tables[0].Rows.Count > 0)
                ((HyperLink)this.dgvIS.HeaderRow.FindControl("hlbtnDetails")).NavigateUrl = "~/F_35_GrAcc/LinkGrpAccount.aspx?Type=INDetails&comcod=" + mCOMCOD + "&Date1=" + Convert.ToDateTime(this.Request.QueryString["Date1"].ToString()).ToString("dd-MMM-yyyy")
        ...
        protected void GetIncomeStatementForPrint()
        {
            ...
            //ReportDocument RptIncomeSt = new RMGiRPT.R_21_GAcc.RptIncomeSt2();
        ...
        protected void GetBalanceSheet()
        {
            ...
            if (ds1.Tables[0].Rows.Count > 0)
                ((HyperLink)this.dgvBS.HeaderRow.FindControl("hlbtnDetailsbs")).NavigateUrl = "~/F_35_GrAcc/LinkGrpAccount.aspx?Type=Details&comcod=" + mCOMCOD + "&Date1=" + Convert.ToDateTime(this.Request.QueryString["Date1"].ToString()).ToString("dd-MMM-yyyy") + "&Date2=" + Convert.ToDateTime(this.Request.QueryString["Date2"].ToString()).ToString("dd-MMM-yyyy");
        ...
        protected void dgvIS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (code == "3AAAAAAAAAAA")
            {
                ...
                hlink1.NavigateUrl = "~/F_35_GrAcc/LinkGrpAccount.aspx?Type=SalDetails&comcod=" + comcod + "&Date1=" + mTRNDAT1 + "&Date2=" + mTRNDAT2;
