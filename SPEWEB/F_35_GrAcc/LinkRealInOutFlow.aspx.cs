...
{
    public partial class LinkRealInOutFlow : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "Month Wise Real Inflow & Outflow";
        ...
        protected void gvMonPayment_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (flow == "A" && code == "99BBBBAAAAAA")
                {
                    ...
                    lgvtoamtmpay.Style.Add("color", "#009999");
                ...
                if (flow == "B" && code == "99BBBBAAAAAA")
                {
                    ...
                    lgvtoamtmpay.Style.Add("color", "#CC33FF");
