...
{
    public partial class LinkGrpIncomestprobasis : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Income Statement (On Production Basis)";


                this.lblfrmDate.Text = this.Request.QueryString["Date1"].ToString();
                this.lbltoDate.Text = this.Request.QueryString["Date1"].ToString();
