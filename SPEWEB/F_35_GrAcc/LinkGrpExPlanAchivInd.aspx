<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="LinkGrpExPlanAchivInd.aspx.cs" Inherits="SPEWEB.F_35_GrAcc.LinkGrpExPlanAchivInd" %>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                                ...
                                <asp:Panel ID="Panel2" runat="server">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 pading5px">
                                            ...
                                            <asp:Label ID="lblAsDate" runat="server" AutoCompleteType="Disabled" CssClass="inputtextbox"></asp:Label>
                    ...
                    <div class="form-group">
                        ...
                        <asp:GridView ID="gvRptExPlnAch" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <asp:TemplateField HeaderText="Date Range">
                                    ...
                                    <FooterTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lgvFTotalPar" runat="server" Font-Bold="True" Font-Size="12px"
                                ...
                                <asp:TemplateField HeaderText="Shipment Acheived">
                                    ...
                                    <FooterTemplate>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lgvFShiQty" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                                        Style="text-align: right"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lgvFShiPar" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                                        Style="text-align: right;"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <asp:TemplateField HeaderText="Production Achieved">
                                    ...
                                    <FooterTemplate>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lgvFProqty" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                                        Style="text-align: right"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lgvFProPar" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                                        Style="text-align: right"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
