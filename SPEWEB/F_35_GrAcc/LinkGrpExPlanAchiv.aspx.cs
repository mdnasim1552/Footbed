...
{
    public partial class LinkGrpExPlanAchiv : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = this.Request.QueryString["Date"].ToString();
        ...
        private void PrintExPlnAchiv()
        {
            ...
            //txtTitle.Text = "As On : " + this.Request.QueryString["Date"].ToString();
        ...
        protected void gvRptExPlnAch_RowDataBound1(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string comcod = this.GetCompCode();
                LcName.NavigateUrl = "~/F_35_GrAcc/LinkGrpExPlanAchivInd.aspx?comcod=" + comcod + "&mlccod=" + mlccod + "&mlcdesc=" + mlcdesc + "&Date=" + Convert.ToDateTime(this.Request.QueryString["Date"].ToString()).ToString("dd-MMM-yyyy");
