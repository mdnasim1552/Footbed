...
{
    public partial class LinkLCIncomeStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.lblActDesc.Text = this.Request.QueryString["mlcdesc"].ToString();
        ...
        private void ShowLCIncomeSt()
        {
            ...
            string mlccode = this.Request.QueryString["mlccod"].ToString();
            string date = this.Request.QueryString["date"].ToString();
            DataSet ds2 = rptdata.GetTransInfo(comcod, "SP_REPORT_ACCOUNTS_LCCVSEXPENSES", "LCCOSTVSEXPENSES", mlccode, date, "", "", "", "", "", "", "");
            if (ds2 == null)
            {
        ...
        protected void lbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            string LCname = this.lblActDesc.Text.Trim();
            ...
            //rpttxtdate.Text = this.lblAsDate.Text.Trim();
