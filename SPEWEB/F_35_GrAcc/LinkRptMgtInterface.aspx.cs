...
namespace SPEWEB.F_35_GrAcc
{
    public partial class LinkRptMgtInterface : System.Web.UI.Page
    {
        ...
        private void GetDynamcifield()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_MGT_INTERFACE", "RPTMGTDYNAMICFIELD", "", "", "", "", "", "", "", "", "");
            if (ds4 == null)
            {
        ...
        private void ShowMgtInterface()
        {
            ...
            DataSet ds3 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_MGT_INTERFACE", "RPTMGTINTERFACE", fdate, tdate, label, order, "", "", "", "", "");
