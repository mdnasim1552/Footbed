<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptAccRecPayment.aspx.cs" Inherits="SPEWEB.F_35_GrAcc.RptAccRecPayment" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 pading5px asitCol3">
                                            <asp:Label ID="lbltakaInLac" runat="server" CssClass="smLbl_to"></asp:Label>
                                        </div>
