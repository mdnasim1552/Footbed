...
namespace SPEWEB.F_35_GrAcc
{
    public partial class LinkGrpRptSaleDues : System.Web.UI.Page
    {
        ...
        protected void lbtngacuname_Click(object sender, EventArgs e)
        {
            ...
            lbljavascript.Text = @"<script>window.open('../F_22_Sal/LinkDuesColl.aspx?Type=ClientLedger&pactcode=" + mACTCODE + "&usircode=" +
        ...
        protected void lbtngvnettodues_Click(object sender, EventArgs e)
        {
            ...
            lbljavascript.Text = @"<script>window.open('../F_22_Sal/LinkDuesColl.aspx?Type=CustInvoice&pactcode=" + mACTCODE + "&usircode=" +
