...
{
    public partial class AccOpeningOld : System.Web.UI.Page
    {
        ...
        private void ShowResource()
        {
            ...
            DataSet ds2 = accData.GetTransInfo(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER", "GETOPENINGRES", filter2, acccode01, "", "", "", "", "", "", "");
        ...
        private void UpdateTable02()
        {
            ...
            for (int i = 0; i < tblt03.Rows.Count; i++)
            {
                ...
                bool resulta = accData.UpdateTransInfo(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER", "ACVOPNUPDATEA", vounum, actcode,
                        rescode, cactcode, voudat, trnqty, trnremark, vtcode, trnamt, spclcode, "", "", "", "", "");
                if (!resulta)
                {
                ...
                for (int i = 0; i < tblt05.Rows.Count; i++)
                {
                    ...
                    if (actlev != "2")
                    {
                        bool resulta = accData.UpdateTransInfo(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER",
                                ...
                                trnremarks, vtcode, trnamt, spclcode, "", "", "", "", "");
                        if (!resulta)
                        {
                            this.lblmsg.Text = accData.ErrorObject["Msg"].ToString();
                            return;
