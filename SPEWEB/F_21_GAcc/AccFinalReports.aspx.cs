    ...
    public partial class AccFinalReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = (mRepID == "IS" ? "Income Statement" :
                    (mRepID == "BS" ? "Balance Sheet" : (mRepID == "BE" ? "Budget Vs Expensis" :
                    (mRepID == "PS" ? "Individual Project Cost-Consolidated Report" : (mRepID == "SPC" ? "Specificition Wise Materials"
                ...
                if (mRepID == "IS" || mRepID == "IS2")
                {
                    ...
                    this.txtOpeningDate.Text = Convert.ToDateTime(this.txtDatefrom.Text).AddMonths(-1).ToString("dd-MMM-yyyy");
        ...
        protected void GetIncomeStatement()
        {
            ...
            if (ds1.Tables[0].Rows.Count > 0)
                ((HyperLink)this.dgvIS.HeaderRow.FindControl("hlbtnDetails")).NavigateUrl = "~/F_21_GAcc/LinkAccount.aspx?Type=INDetails&Date1=" + Convert.ToDateTime(this.txtDatefrom.Text).ToString("dd-MMM-yyyy")
        ...
        protected void GetIncomeStatementForPrint()
        {
            ...
            ReportDocument RptInSt = new RMGiRPT.R_21_GAcc.RptAccIncomeSt();
        ...
        protected void GetBalanceSheetForPrint()
        {
            ...
            ReportDocument RptBalanceSheet = new RMGiRPT.R_21_GAcc.RptBalanceSheet2();
            ...
            TxtOpening.Text = Convert.ToDateTime(mTRNDAT1).AddDays(-1).ToString("dd-MM-yyyy");

            TextObject TxtClosing = RptBalanceSheet.ReportDefinition.ReportObjects["TxtClosing"] as TextObject;
            TxtClosing.Text = Convert.ToDateTime(mTRNDAT2).ToString("dd-MM-yyyy");
        ...
        protected void GetSpeBalnSheetPrint()
        {
            ...
            string mTRNDAT1 = Convert.ToDateTime(this.txtDatefrom.Text).ToString("dd-MMM-yyyy");
            string mTRNDAT2 = this.txtDateto.Text.Substring(0, 11);
            ReportDocument RptBalanceSheet = new RMGiRPT.R_21_GAcc.RptSpeBalnSheet();
            RptBalanceSheet.SetDataSource((DataTable)ViewState["tblAcc"]);
            TextObject TxtCompName = RptBalanceSheet.ReportDefinition.ReportObjects["TxtCompName"] as TextObject;
            TxtCompName.Text = comnam;
        ...
        protected void GetBalanceSheet()
        {
            ...
            if (ds1.Tables[0].Rows.Count > 0)
                ((HyperLink)this.dgvBS.HeaderRow.FindControl("hlbtnDetailsbs")).NavigateUrl = "~/F_21_GAcc/LinkAccount.aspx?Type=Details&Date1=" + Convert.ToDateTime(this.txtDatefrom.Text).ToString("dd-MMM-yyyy") + "&Date2=" + Convert.ToDateTime(this.txtDateto.Text).ToString("dd-MMM-yyyy");
        ...
        private void SHOWSHAREEQUIT()
        {
            ...
            DataSet ds2 = accData.GetTransInfo(comcod, "SP_REPORT_ACCOUNTS_IS_BS_R2", "RPTSHAREHOLDEREQUITY", date1, date2, "", "", "", "", "", "", "");
            if (ds2 == null)
                return;
            if (ds2.Tables[0].Rows.Count == 0)
            {
        ...
        protected void ReportBudgetvsExpenses()
        {
            ...
            if (dt1.Rows.Count == 0)
                return;
            ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptAccFinalReports();
        ...
        protected void ReportLandStatus()
        {
            ...
            //if (dt1.Rows.Count == 0)
            //    return;
            //ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptAccFinalReportsLand();
        ...
        private void PrintSpcDesc()
        {
            ...
            ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptResSpecificition();
        ...
        private void PrintIncomeIPrj()
        {
            ...
            if (dt1.Rows.Count == 0)
                return;
            ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptIncomestIndPrj();
        ...
        protected void PrintShareQty()
        {
            ...
            DataTable dt = (DataTable)Session["tblfinst"];
            if (dt.Rows.Count == 0)
                return;

            var lst = dt.DataTableToList<SPEENTITY.C_21_Acc.EClassAccVoucher.Shequity>();

            LocalReport rpt1 = new LocalReport();
            rpt1 = RptSetupClass.GetLocalReport("R_21_GAcc.RptShareQty", lst, null, null);
            ...
            rpt1.SetParameters(new ReportParameter("RptTitle", "STATEMENT OF SHARE HOLDER'S EQUITY VIEW/PRINT SCREEN"));
            rpt1.SetParameters(new ReportParameter("Logo", ComLogo));
            rpt1.SetParameters(new ReportParameter("Level", "Report Level: " + this.DDListLevels.SelectedItem.ToString().Trim()));
        ...
        private void PrintShareQtyOLD()
        {
            ...
            ReportDocument RptShareQty = new RMGiRPT.R_21_GAcc.RptShareQty();
            ...
            TextObject txtuserinfo = RptShareQty.ReportDefinition.ReportObjects["txtuserinfo"] as TextObject;
            txtuserinfo.Text = ASTUtility.Concat(compname, username, printdate);
        ...
        protected void RptProjectReoprt()
        {
            ...
            ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptAccProjectReport1();
        ...
        protected void GetProjectStatusForPrint()
        {
            ...
            ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptAccProjectReport();
        ...
        protected void dgvSpBS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (code.Length > 2 && ((ASTUtility.Right(code, 3) == "000") || (ASTUtility.Right(code, 3) == "AAA")))
                {
