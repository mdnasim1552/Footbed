...
namespace SPEWEB.F_21_GAcc
{
    public partial class AccLedger : System.Web.UI.Page
    {
        ...
        protected void lnkShowLedger_Click(object sender, EventArgs e)
        {
            ...
            ((HyperLink)this.dgv2.HeaderRow.FindControl("hlbtnCBdataExel")).Enabled = (Convert.ToBoolean(dr1[0]["printable"]));
        ...
        private void PrintLedgerWithQty()
        {
            ...
            //SPEENTITY.R_21_GAcc.RptAccSLedger rptstk = new SPEENTITY.R_21_GAcc.RptAccSLedger();
        ...
        private void PrintLedger()
        {
            ...
            string username = hst["username"].ToString();
            string printdate = System.DateTime.Now.ToString("dd.MM.yyyy hh:mm:ss tt");
           // ReportDocument rptstk = new SPEENTITY.C_21_Acc.RptAccLedger();
            string Resdesc = "";
            if (Request.QueryString["Type"].ToString() == "SubLedger")
            {
