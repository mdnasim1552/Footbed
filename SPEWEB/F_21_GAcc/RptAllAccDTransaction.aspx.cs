    ...
    public partial class RptAllAccDTransaction : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.LblTitle.Text = "Transaction with Post Dated Cheque";
        ...
        private void PrintCashBook()
        {
            ...
            //TextObject rptCname = rptcb1.ReportDefinition.ReportObjects["ProjectName"] as TextObject;
            //rptCname.Text = "Transaction with Post Dated Cheque";
        ...
        //    ReportDocument rptdtlist = new RMGiRPT.R_17_Acc.RptDailyTransaction();
        ...
        //    ReportDocument rptrandpay = new RMGiRPT.R_17_Acc.RptRecAndPayment();
        ...
        //    DataTable dt = (DataTable)Session["tranlist"];
        //    ReportDocument rptdtlist = new RMGiRPT.R_17_Acc.RptDailyPayProposal();
        //    TextObject rptCname = rptdtlist.ReportDefinition.ReportObjects["CompName"] as TextObject;
        //    rptCname.Text = comnam;
        //    TextObject rptdate = rptdtlist.ReportDefinition.ReportObjects["date"] as TextObject;
        //    rptdate.Text = "(From " + Convert.ToDateTime(this.txtfromdate.Text).ToString("dd-MMM-yyyy") + " To " + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy") + ")";
        ...
        //    DataTable dt = (DataTable)Session["tranlist"];
        //    ReportDocument rptdtlist = new RMGiRPT.R_17_Acc.RptDelDailyTransaction();
        //    TextObject rptCname = rptdtlist.ReportDefinition.ReportObjects["CompName"] as TextObject;
        //    rptCname.Text = comnam;
        //    TextObject rptdate = rptdtlist.ReportDefinition.ReportObjects["date"] as TextObject;
        //    rptdate.Text = "(From " + Convert.ToDateTime(this.txtfromdate.Text).ToString("dd-MMM-yyyy") + " To " + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy") + ")";
        ...
        protected void imgbtnSearchVoucherCash_Click(object sender, ImageClickEventArgs e)
        {
            this.ShowCashBook();
        }
