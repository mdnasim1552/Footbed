<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="AccPayment.aspx.cs" Inherits="SPEWEB.F_21_GAcc.AccPayment" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 pading5px">
                                        ...
                                        <asp:DropDownList ID="ddlPrivousVou" runat="server" CssClass="ddlistPull" TabIndex="4" Style="width: 193px;">
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 pading5px asitCol3">
                                            ...
                                            <asp:TextBox ID="txtserchReCode" runat="server" CssClass="inputtextbox" TabIndex="15"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 pading5px asitCol3">
                                            ...
                                            <asp:TextBox ID="txtDrAmt" runat="server" CssClass=" inputtextbox" TabIndex="18"></asp:TextBox>
                                        ...
                                        <div class="col-md-9 pading5px">
                                            ...
                                            <asp:TextBox ID="txtChequeNo" runat="server" CssClass=" inputtextbox" TabIndex="19"></asp:TextBox>
                                ...
                                <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px">
                                                <asp:DropDownList ID="ddlgrdacccode" runat="server" CssClass="form-control inputTxt"
                                                    OnSelectedIndexChanged="ddlgrdacccode_SelectedIndexChanged" TabIndex="28" style="width:270px;" AutoPostBack="True">
                                                </asp:DropDownList>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px">
                                                <asp:DropDownList ID="ddlrgrdesuorcecode" runat="server" CssClass="form-control inputTxt"
                                                    TabIndex="31"  style="width:270px;">
                                                </asp:DropDownList>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccdesc1" runat="server"
                                           ...
                                           TabIndex="75" Width="250"></asp:Label>
