...
namespace SPEWEB.F_21_GAcc
{
    public partial class AccPayUpdate : System.Web.UI.Page
    {
        ...
        protected void lbok_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "CallMyFunction", "showContentFail('Voucher No already Existing in this PV or DV No');", true);
                return;
            }
            ...
            //  if (ds4.Tables[0].Rows[0]["acvounum"].ToString() != "00000000000000")
            //  {
            //      this.lblmsg.Text = "Voucher No already Existing in this PV or DV No";
            //      return;
            //  }
