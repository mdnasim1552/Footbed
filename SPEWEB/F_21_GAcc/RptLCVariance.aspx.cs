...
{
    public partial class RptLCVariance : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Income Statement - Budget Vs. Actual";
        ...
        private void GetMasterLc()
        {
            ...
            string txtsrch = "%";
            DataSet ds2 = rptdata.GetTransInfo(comcod, "SP_INV_STDANA", "GETORDERMLCCOD", txtsrch, "%", "", "", "", "", "", "");
            ...
            this.ddlMLc_SelectedIndexChanged(null,null);
        ...
        protected void lbtnPrint_Click()
        {
            Hashtable hst = (Hashtable)Session["tblLogin"];
            ...
            var lst = dt.DataTableToList<SPEENTITY.C_21_Acc.EClassAccVoucher.MLCCost>();

            LocalReport rpt1 = new LocalReport();
            rpt1 = RptSetupClass.GetLocalReport("R_21_GAcc.RptLCCostVsEx", lst, null, null);
            rpt1.EnableExternalImages = true;

            rpt1.SetParameters(new ReportParameter("comnam", comnam));
            rpt1.SetParameters(new ReportParameter("AsOnDate", "(As on " + Convert.ToDateTime(this.txttoDate.Text).ToString("dd-MMM-yyyy") + ")"));
            rpt1.SetParameters(new ReportParameter("comadd", comadd));
            rpt1.SetParameters(new ReportParameter("RptTitle", "WORKING BUDGET Vs. ACHIEVEMENT VIEW/EDIT"));
            rpt1.SetParameters(new ReportParameter("ComLogo", ComLogo));
            rpt1.SetParameters(new ReportParameter("LCNO", "LC Name: " + LCname));
        ...
        protected void lbtnPrint_ClickOLD(object sender, EventArgs e)
        {
            ...
            //rpttxtdate.Text = "(As on " + Convert.ToDateTime(this.txttoDate.Text).ToString("dd-MMM-yyyy") + ")";
