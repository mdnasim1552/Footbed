<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="LinkAccount.aspx.cs" Inherits="SPEWEB.F_21_GAcc.LinkAccount" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2 col-lg-2 ">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblfrmdate" runat="server" CssClass="form-control form-control-sm small "></asp:Label>
                                ...
                                <div class="col-md-2 col-sm-2 col-lg-2 ">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lbltodate" runat="server" CssClass="form-control form-control-sm small "></asp:Label>
