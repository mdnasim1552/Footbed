...
namespace SPEWEB.F_21_GAcc
{
    public partial class LinkRptReciptPayment : System.Web.UI.Page
    {
        ...
        protected void btnok_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_REPORT_DASH_BOARD_INFO", "RECEPIPTPAYMENT", frmdate, todate, payment, "", "", "", "", "", "");
            if (ds1 == null)
            {
            ...
            if (this.Request.QueryString["paycode"].Length > 0)
            {
                ...
                dv1.RowFilter = ("paycode like '26%' or paycode like '14%'");
                dt = dv1.ToTable();
            }
            else
            {
        ...
        private void ShowGraph()
        {
            ...
            //dt = dv.ToTable();
            var lst = dt.DataTableToList<SPEENTITY.C_21_Acc.EClassAccounts.EClassReciptvspayment>();
            var lst2 = dt2.DataTableToList<SPEENTITY.C_21_Acc.EClassAccounts.EClassReciptvspayment>();
            var lstmainhead = dt3.DataTableToList<SPEENTITY.C_21_Acc.EClassAccounts.EClassReciptvspayment>();
