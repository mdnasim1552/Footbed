    ...
    public partial class RptAccSpLedger : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = (Request.QueryString["Type"].ToString().Trim() == "DetailLedger") ? "Account Special Ledger"
        ...
        private void PrintDetailLedger()
        {
            ...
            //((Label)this.Master.FindControl("lblprintstk")).Text = @"<script>window.open('Print.aspx?Type=Spdetledger&genno=" + resource + "&date1=" + frmdate + "&date2=" + todate + "', target='_blank');</script>";

            //Response.Redirect("Print.aspx?Type=Spdetledger&genno=" + resource + "&date1=" + frmdate + "&date2=" + todate + "");
            //Hashtable hst = (Hashtable)Session["tblLogin"];
        ...
        private void PrintSPaymentPro()
        {
            ...
            //ReportDocument rptsl = new RMGiRPT.R_21_GAcc.RptSupPayment();
            //DataTable dt = (DataTable)Session["tblspledger"];
        ...
        private void PrintASOrConPayment02()
        {
            ...
            //ReportDocument rptsl = new RMGiRPT.R_21_GAcc.RptSupPayment02();
            //TextObject txtfdate = rptsl.ReportDefinition.ReportObjects["date"] as TextObject;
            //txtfdate.Text = " (From " + Convert.ToDateTime(this.txtDateFrom.Text).ToString("dd-MMM-yyyy") + " To " + Convert.ToDateTime(this.txtDateto.Text).ToString("dd-MMM-yyyy") + " )";
        ...
        private void PrintASOrConPayment()
        {
            ...
            string username = hst["username"].ToString();
            string printdate = System.DateTime.Now.ToString("dd.MM.yyyy hh:mm:ss tt");
            //ReportDocument rptsl = new RMGiRPT.R_21_GAcc.RptAllSupPayment();
            //DataTable dt = (DataTable)Session["tblspledger"];
        ...
        private void RptMonthlyIsuVsPay()
        {
            ...
            string username = hst["username"].ToString();
            string printdate = System.DateTime.Now.ToString("dd.MM.yyyy hh:mm:ss tt");
            //ReportDocument rptsl = new RMGiRPT.R_21_GAcc.RptMonthlyIsuVsPay();
            //DataTable dt = (DataTable)Session["tblspledger"];
        ...
        private void RptMonthlyIsuVsPaySum()
        {
            ...
            string username = hst["username"].ToString();
            string printdate = System.DateTime.Now.ToString("dd.MM.yyyy hh:mm:ss tt");
            //ReportDocument rptsl = new RMGiRPT.R_21_GAcc.RptMonthlyIsuVsPaySum();
            //DataTable dt = (DataTable)Session["tblspledger"];
