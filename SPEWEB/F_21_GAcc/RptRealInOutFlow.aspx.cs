...
namespace SPEWEB.F_21_GAcc
{
    public partial class RptRealInOutFlow : System.Web.UI.Page
    {
        ...
        private void PrintMonRecorPayment()
        {
            ...
            ReportDocument rptstk = new RMGiRPT.R_21_GAcc.RptRealFlow();
        ...
        protected void gvMonPayment_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (flow == "A" && code == "99BBBBAAAAAA")
                {
                    ...
                    toamtmpay.NavigateUrl = "~/F_21_GAcc/LinkInflowAndOutflow.aspx?Type=MonReceipt&Date1=" + Convert.ToDateTime(this.txtfromdate.Text).ToString("dd-MMM-yyyy") + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");
                ...
                if (flow == "B" && code == "99BBBBAAAAAA")
                {
                    ...
                    toamtmpay.NavigateUrl = "~/F_21_GAcc/LinkInflowAndOutflow.aspx?Type=MonPaymentDet&Date1=" + Convert.ToDateTime(this.txtfromdate.Text).ToString("dd-MMM-yyyy") + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");
                }
