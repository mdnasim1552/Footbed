...
{
    public partial class LinkInflowAndOutflow : System.Web.UI.Page
    {
            ...
            switch (type)
            {
                ...
                case "DailyPayment":
                    ...
                    if (this.rbtPayment.SelectedIndex == 1)
                    {
                        ...
                        //  this.lblHeader.Text = "Daily Payment Details Report";
                    }
        ...
        private void ShowMonPayorReceipt()
        {
            ...
            string txtdatefrm = Convert.ToDateTime(this.Request.QueryString["Date1"].ToString()).ToString("dd-MMM-yyyy");
            string txtdateto = Convert.ToDateTime(this.Request.QueryString["Date2"].ToString()).ToString("dd-MMM-yyyy");
        ...
        private void PrintMonCollection()
        {
            ...
            //txtdate.Text = this.lblAsDate.Text;


            //DateTime datefrm = Convert.ToDateTime(this.Request.QueryString["Date1"].ToString());
            //DateTime = Convert.ToDateTime(this.Request.QueryString["Date2"].ToString());
        ...
        private void PrintMonRecorPayment()
        {
            ...
            //DateTime datefrm = Convert.ToDateTime(this.Request.QueryString["Date1"].ToString());
            //DateTime dateto = Convert.ToDateTime(this.Request.QueryString["Date1"].ToString());
            //for (int i = 1; i <= 12; i++)
            //{
            //    if (datefrm > dateto)
            //        break;
