<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptAccDTransBankSt.aspx.cs" Inherits="SPEWEB.F_21_GAcc.RptAccDTransBankSt" %>
                    ...
                    <div class="row table-responsive">
                        <asp:GridView ID="gvcashbookp" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Bank Clearing Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblgvCDate1" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "recndt1")) %>'
                                                        Width="65px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Voucher #">
                    ...
                    <div class="row table-responsive">
                        <asp:GridView ID="gvDepUnclr" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cash">
                                                <ItemTemplate>
                                                    <asp:Label ID="lgvCashAmtDV" runat="server" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "casham")).ToString("#,##0.00;(#,##0.00); ") %>'
                                                        Width="65px" Style="text-align: right"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
