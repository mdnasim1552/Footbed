<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="RptAccSpLedger.aspx.cs" Inherits="SPEWEB.F_21_GAcc.RptAccSpLedger" %>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            ...
                            <cc1:CalendarExtender ID="txtDateFrom_CalendarExtender" runat="server" Format="dd-MMM-yyyy" TargetControlID="txtDateFrom" Enabled="true"></cc1:CalendarExtender>
                        </div>
                        <div class="col-md-1">
                            <asp:Label ID="lbltoDate" runat="server" Text="To"></asp:Label>
                            <asp:TextBox ID="txtDateto" runat="server" AutoCompleteType="Disabled" CssClass="form-control form-control-sm" ToolTip="(dd-MM-yyyy)"></asp:TextBox>
                            <cc1:CalendarExtender ID="txtDateto_CalendarExtender" runat="server" Format="dd-MMM-yyyy" TargetControlID="txtDateto" Enabled="true"></cc1:CalendarExtender>

                        </div>

                        <div class="form-group">
                            <div class="col-md-5">
                                <asp:LinkButton ID="lblcontrolAccResCode" runat="server" CssClass="lblTxt lblName" OnClick="ibtnFindRes_Click" Text="Resource Heads">
                                </asp:LinkButton>
                                <asp:TextBox ID="txtSrchRes" runat="server" CssClass="hidden inputtextbox"></asp:TextBox>
                                <asp:DropDownList ID="ddlConAccResHead" Width="400" runat="server" CssClass="form-control inputTxt chzn-select">
                                </asp:DropDownList>
                            </div>

                            <div class="col-md-1">
                                <div style="margin-top: 20px">
                                    <asp:LinkButton ID="lnkShowLedger" runat="server" CssClass="btn btn-sm btn-primary okBtn" OnClick="lnkShowLedger_Click">Ok</asp:LinkButton>
                                        ...
                                        <asp:TemplateField HeaderText="Opening">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvOpAmount" runat="server" CssClass="GridLebel"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "opam")).ToString("#,##0.00;(#,##0.00); ") %>' Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Closing">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvClAmount" runat="server" CssClass="GridLebel"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "clsam")).ToString("#,##0.00;(#,##0.00); ") %>' Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="hlbtntbCdataExel" runat="server" BackColor="#000066"
                                                                    ...
                                                                    ForeColor="White" Style="text-align: center" Width="90px">Excel</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </HeaderTemplate>
