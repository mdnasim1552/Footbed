...
namespace SPEWEB.F_64_Mgt
{
    public partial class UserLoginfrm : System.Web.UI.Page
    {
        ...
        protected void gvUseForm_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string empcode = ((DropDownList)this.gvUseForm.Rows[e.RowIndex].FindControl("ddlUserName")).Text.Trim();

            bool result = User.UpdateTransInfo(comcod, "SP_UTILITY_LOGIN_MGT", "INSORUPDATEUSR", usrid, usrsname,
                      usrfname, usrdesig, usrpass, usrrmrk, active, empcode, "", "", "", "", "", "", "");
            if (!result)
            {
        ...
        protected void gvUseForm_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            DropDownList ddl2 = (DropDownList)this.gvUseForm.Rows[e.NewEditIndex].FindControl("ddlUserName");
            Panel pnl02 = (Panel)this.gvUseForm.Rows[e.NewEditIndex].FindControl("Panel2");

            ViewState["gindex"] = e.NewEditIndex;
            string SearchProject = "%" + ((TextBox)gvUseForm.Rows[e.NewEditIndex].FindControl("txtSearchUserName")).Text.Trim() + "%";
            DataSet ds1 = User.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK_NEW", "GETEMPTIDNAMEUPER", SearchProject, "", "", "", "", "", "", "", "");
        ...
        {
            this.ddlModuleName.SelectedValue = "00";
        ...
        protected void lbtnUpPer_Click(object sender, EventArgs e)
        {
            ...
            string comcod = this.GetComeCode();
            string usrid = this.lblusrid.Text;
            string modname = (this.ddlModuleName.SelectedValue.Trim() == "00" ? "" : this.ddlModuleName.SelectedValue.ToString()) + "%";
        ...
        protected void ibtnSrchProject_Click(object sender, EventArgs e)
        {
            ...
            DropDownList ddl2 = (DropDownList)this.gvUseForm.Rows[rowindex].FindControl("ddlUserName");
            string SearchProject = "%" + ((TextBox)gvUseForm.Rows[rowindex].FindControl("txtSearchUserName")).Text.Trim() + "%";
            DataSet ds1 = User.GetTransInfo("", "SP_ENTRY_CODEBOOK_NEW", "GETEMPTIDNAMEUPER", SearchProject, "", "", "", "", "", "", "", "");
            ddl2.DataTextField = "empname";
            ddl2.DataValueField = "empid";
            ddl2.DataSource = ds1;
            ddl2.DataBind();
