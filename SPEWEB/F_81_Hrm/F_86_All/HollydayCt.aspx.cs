...
namespace SPEWEB.F_81_Hrm.F_86_All
{
    public partial class HollydayCt : System.Web.UI.Page
    {
        ...
        private void GetEmployeeName()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "GETEMPLOYEENAME", IdCard, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void ddlMonth_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string empid = this.ddlEmpName.SelectedValue.ToString();
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPABSENT", "HOLLY_DATE", date, empid, "", "", "", "", "", "", "");
        ...
        protected void lnkbtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.chkDate.Items.Count; i++)
            {
                ...
                bool result = HRData.UpdateTransInfo(comcod, "SP_ENTRY_EMPLOYEE01", "INSERTORUPDATEHOLIDAY", dayid, empid, gcod, date, txthstatus, "", "", "", "", "", "", "", "", "", "");
            }
