...
namespace SPEWEB.F_81_Hrm.F_83_Att
{
    public partial class EmpEarlyLeaveApproval : System.Web.UI.Page
    {
        ...
        private void GetMonth()
        {
            ...
            //DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPABSENT", "GETMONTHFORABS", "", "", "", "", "", "", "", "", "");
        ...
        protected void lnkbtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            //bool result = HRData.UpdateTransInfo(comcod, "SP_ENTRY_EMPABSENT", "DELETEABSCT", empid, monyr, "", "", "", "", "", "", "", "", "", "", "", "", "");
            //if (result == false) 
            //{
            ...
            //        string absfl ="1";
            //        bool result1 = HRData.UpdateTransInfo(comcod, "SP_ENTRY_EMPABSENT", "INORUPDATEABSENTCT", empid, absdat, absfl, monyr, "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void SaveValue()
        {
            ...
            {
                string approved = ((TextBox)this.gvMonthlyAttn.Rows[i].FindControl("txtgvapproved")).Text.Trim();
        ...
        protected void lFinalUpdate_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr1 in dt.Rows)
            {
                ...
                bool result = HRData.UpdateTransInfo(comcod, "dbo_hrm.SP_ENTRY_EMPLOYEE01", "UPDATEEARLEAVEAPP", dayid, empid, earleaveapp, "", "", "", "", "", "", "", "", "", "", "", "");
