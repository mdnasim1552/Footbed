<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptWeekPresence.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_83_Att.RptWeekPresence" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 pading5px">
                                <div class="col-md-3 col-sm-3 col-lg-3 pading5px">
                                    ...
                                    <asp:DropDownList ID="ddlWstation" runat="server" Width="205"  CssClass="chzn-select pull-left" AutoPostBack="true" TabIndex="2"></asp:DropDownList>
                                </div>
                                ...
                                <asp:Label ID="Label1" runat="server" Visible="false" CssClass="smLbl_to">To</asp:Label>

                                <asp:TextBox ID="txtTdate" runat="server" Visible="false"  CssClass="inputDateBox "></asp:TextBox>
