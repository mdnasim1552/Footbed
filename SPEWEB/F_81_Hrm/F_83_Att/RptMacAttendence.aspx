<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptMacAttendence.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_83_Att.RptMacAttendence" %>
                ...
                <fieldset class="scheduler-border fieldset_A">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:Label ID="Label1" runat="server" CssClass="lblTxt lblName">Machine</asp:Label>
                                <asp:DropDownList ID="ddlMachine" runat="server">
                                    <asp:ListItem Value="AIOR173960187">AIOR173960187</asp:ListItem>
                                     <asp:ListItem Value="AIOR173760288">AIOR173760288</asp:ListItem>
                            ...
                            <div class="col-md-4">
                                        <div class="formrow">
                                            ...
                                            <asp:Panel ID="pnlxcel" runat="server">
                                                ...
                                                <asp:LinkButton ID="btnexcuplosd" runat="server" Style="margin-left: 100px;" CssClass=" btn btn-xs btn-success" Text="GET REPORT" OnClick="btnexcuplosd_Click" ></asp:LinkButton>
