<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="EmpMonthSummary.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_89_Pay.EmpMonthSummary" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4 pading5px">
                                        ...
                                        <asp:DropDownList ID="ddlEmpName" Width="200" runat="server" CssClass="chzn-select form-control inputTxt" Visible="false"></asp:DropDownList>
                                        <asp:Label ID="lblfrmdate" runat="server" CssClass="lblTxt lblName" Width="68">Date</asp:Label>
                                    ...
                                    <div class="col-md-1">
                                       <asp:Label ID="lblEmplist" runat="server" CssClass="smLbl_to">Employee List:</asp:Label>
                                    </div>                                     
                                    <div class="col-md-2 pading5px">
