...
namespace SPEWEB.F_81_Hrm.F_89_Pay
{
    public partial class EmpLoanInfo : System.Web.UI.Page
    {
        ...
        private void GetLoanNo()
        {
            ...
            DataSet ds3 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "LASTLOANNO", date, "", "", "", "", "", "", "", "");
            if (ds3 == null)
                return;
        ...
        private void GetEmplist()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "GETLNEMPLIST", txtEmpname, "", "", "", "", "", "", "", "");
        ...
        private void GetPreLnlist()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "GetPrevLN", curdate, "", "", "", "", "", "", "", "");
        ...
        private void ShowLoanInfo()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "GETLNINFO", mLnNo, CurDate1,
                          "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void lbtnFinalUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                result = HRData.UpdateTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "INSERTORUPDATELN", "LNINFB", lnno, curdate, toamt, "",
                       "", "", "", "", "", "", "", "", "", "");
                if (!result)
                {
                    return;
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    result = HRData.UpdateTransInfo(comcod, "SP_ENTRY_EMPLOYEE", "INSERTORUPDATELN", "LNINFA", lnno, empid, lndate, lnamt, "",
                        "", "", "", "", "", "", "", "", "");
                    if (!result)
                        return;
                }
