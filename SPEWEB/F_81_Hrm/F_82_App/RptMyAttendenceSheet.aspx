<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptMyAttendenceSheet.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_82_App.RptMyAttendenceSheet" %>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <asp:Label ID="Label1" runat="server" CssClass=" lblTxt lblName lblName2">Total OT</asp:Label>
            ...
            <asp:Repeater ID="RptMyAttenView" runat="server" OnItemDataBound="RptMyAttenView_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblactualattnminute" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "actualattnminute")).ToString() %>'></asp:Label>
