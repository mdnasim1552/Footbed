...
{
    public partial class EmpAccNoUpload : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "EMPLOYEE ACC NO UPLOAD";
            ...
            if (fileuploadExcel.HasFile)
            {
                try
                {
                    ...
                    string query = "SELECT [ID],[NAME], [BANK], [ACC_NO] FROM [Sheet1$]";
        ...
        {
            {
                ...
                ds.Merge(dt);
                ds.Tables[0].TableName = "tblcard";
                //var temp = ds.GetXml();
                bool result = HRData.UpdateXmlTransInfo(comcod, "dbo_hrm.SP_ENTRY_EMPLOYEE01", "EMPLOYEE_ACC_NO_UPDATED", ds, null, null);
                if (result)
                {
