...
{
    public partial class RptEmpSkillReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "EMPLOYEE SKILL REPORT";
                GetWorkStation();
        ...
        private void GetEmpName()
        {
            ...
            DataSet ds3 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_EMPLOYEE_REGISTER", "EMPLOYEE_SKILL_INFORMATION", emptype, dpt, section, "", "", "", "", "", "");
            if (ds3 == null)
            {
                return;
            }
            ...
            ViewState["empskill"] = ds3.Tables[0];
        ...
        protected void lbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = (DataTable)ViewState["empskill"];

            var lst1 = dt.DataTableToList<SPEENTITY.C_81_Hrm.C_82_App.EmployeeInfo.EmployeeSkill>();
            
  

     
            LocalReport Rpt1 = new LocalReport();
            Rpt1 = SPERDLC.RptSetupClass.GetLocalReport("RD_81_HRM.RD_82_App.RptEmpSkillReport", lst1, null, null);
