...
namespace SPEWEB.F_81_Hrm.F_82_App
{
    public partial class EmpBirthDeath : System.Web.UI.Page
    {
        ...
        private void GetCompany()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "GETCOMPANYNAME", txtCompany, userid, "", "", "", "", "", "", "");
        ...
        private void GetProjectName()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "DEPARTMENTNAME", Company, txtSProject, "", "", "", "", "", "", "");
        ...
        private void GetDesignation()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", callType, "", "", "", "", "", "", "", "", "");
        ...
        private void GetSepType()
        {
            Hashtable hst = (Hashtable)Session["tblLogin"];
            string comcod = this.GetCompCode();
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "GETSEAPRATIONTYPE", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowData()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "GETJOINSUMMARY", Fdate, Tdate, Company, Deptid, DesigFrom, DesigTo, "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetEmpListJoiningDWise()
        {
            ...
            string Fdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string Tdate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "GETEMPLISTJDATEWISE", Company, Deptid, DesigFrom, DesigTo, Fdate, Tdate, "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetEmpList()
        {
            ...
            string Fdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string Tdate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "RPTDEATHWISHBIRTHDAY", Company, Deptid, DesigFrom, DesigTo, Fdate, Tdate, "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetTransList()
        {
            ...
            string Fdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string Tdate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "GETEMPTRANSFERLIST", Fdate, Tdate, Company, Deptid, DesigFrom, DesigTo, "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetPenConfirmation()
        {
            ...
            string section = "%";
            string division = "%";
            DataSet ds4 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_HR_EMPSTATUS2", "RPTPENCONFIRMATION", "", section, Company, division, Fdate, Tdate, "", "", "");
            //DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "RPTPENCONFIRMATION", Company, Deptid, DesigFrom, DesigTo, Fdate, Tdate, "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetEmpConfirmation()
        {
            ...
            string Fdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string Tdate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "RPTEMPCONFIRMATION", Company, Deptid, DesigFrom, DesigTo, Fdate, Tdate, "", "", "");
            if (ds4 == null)
            {
                this.gvEmpCon.DataSource = null;
                this.gvEmpCon.DataBind();
        ...
        private void GetEmpManPower()
        {
            ...
            string Fdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string Tdate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "RPTEMPMANPOWER", Company, Fdate, Tdate, "", "", "", "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetEmpSPList()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "SHOWEMPSPLIST", Fdate, Tdate, Company, Deptid, DesigFrom, DesigTo, sptype, "", "");
            if (ds4 == null)
            {
        ...
        private void GetEmpHoldList()
        {
            ...
            string Fdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string Tdate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "RPTPEMPHOLDLIST", Company, Deptid, DesigFrom, DesigTo, Fdate, Tdate, "", "", "");
            if (ds4 == null)
            {
        ...
        private void GetEmpLowHighSal()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_EMPSTATUS2", "GRDEGWISESALARYDET", Company, Deptid, GradeFrom, GradeTo, "", "", "", "", "");
            if (ds4 == null)
            {
        ...
        private void PrintEmpListJoiningDWise()
        {
            ...
            string fromdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string todate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            ReportDocument rptstate = new RMGiRPT.R_81_Hrm.R_92_Mgt.RptDateWiseJoining();
            TextObject rptCname = rptstate.ReportDefinition.ReportObjects["txtCompName"] as TextObject;
            rptCname.Text = comnam;
        ...
        private void PrintEmpBirthdayList()
        {
            ...
            ReportDocument rptstate = new RMGiRPT.R_81_Hrm.R_82_App.RptEmpListJBirthDayWise();
            TextObject rptCname = rptstate.ReportDefinition.ReportObjects["txtCompName"] as TextObject;
            rptCname.Text = comnam;
            TextObject rptftdate = rptstate.ReportDefinition.ReportObjects["txtfrmdatetodate"] as TextObject;
            rptftdate.Text = "Date: " + fromdate + " To " + todate;
        ...
        private void RptEmpConfirmation()
        {
            ...
            string fromdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string todate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            ReportDocument rptstate = new RMGiRPT.R_81_Hrm.R_92_Mgt.RptDateWiseEmpCon();
            TextObject rptCname = rptstate.ReportDefinition.ReportObjects["txtCompName"] as TextObject;
            rptCname.Text = comnam;
        ...
        private void RptEmpSPList()
        {
            ...
            string fromdate = Convert.ToDateTime(this.txtFdate.Text).ToString("dd-MMM-yyyy");
            string todate = Convert.ToDateTime(this.txtTdate.Text).ToString("dd-MMM-yyyy");
            ReportDocument rptstate = new RMGiRPT.R_81_Hrm.R_92_Mgt.RptEmpSpList();
            DataTable dt = (DataTable)Session["tblEmpstatus"];
            TextObject rptCname = rptstate.ReportDefinition.ReportObjects["txtCompName"] as TextObject;
            rptCname.Text = comnam;
            TextObject rptftdate = rptstate.ReportDefinition.ReportObjects["txtfrmdatetodate"] as TextObject;
