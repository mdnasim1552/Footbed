<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptNewJoingInfo.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_97_MIS.RptNewJoingInfo" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px" style="display:none;">
                                        <asp:Label ID="lblOrderList0" runat="server" CssClass=" lblTxt lblName">Order Field</asp:Label>
                                        ...
                                        <asp:DropDownList ID="ddlReportLevel" runat="server" Width="150" CssClass="ddlPage62 inputTxt margin5px"
                                            ...
                                            <asp:ListItem Selected="True" Value="4">Details</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
