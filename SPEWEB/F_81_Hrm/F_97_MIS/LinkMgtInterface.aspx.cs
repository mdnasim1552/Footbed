...
namespace SPEWEB.F_81_Hrm.F_97_MIS
{
    ...
    public partial class LinkMgtInterface : System.Web.UI.Page
    {
        ...
        private void GetEmpName()
        {
            ...
            DataSet ds3 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_MGT_INTERFACE", "GETEMPID", txtSEmployee, empid, "", "", "", "", "", "", "");
            if (ds3 == null)
                return;
        ...
        private void PrintEmpAttnIdWise()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_ATTENDENCE", "EMPATTNIDWISE", frmdate, todate, empid, "", "", "", "", "", "");
            ...
            //ReportDocument rptTest = new RMGiRPT.R_81_Hrm.R_83_Att.rptDailyAttnEmp();
