<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="AllEmpList.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_92_Mgt.AllEmpList" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-lg-2 ">
                            <div class="form-group" style="margin-top: 20px;">
                                ...
                                <a href='<%=this.ResolveUrl("~/F_81_Hrm/F_97_MIS/RptMgtInterface.aspx")%>' class="btn btn-waring btn-sm" target="_blank">Next
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="well well-sm" style="height: 100px; margin-bottom: 2px;">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-8 pading5px">
                                                    ...
                                                    <p>
                                                        <asp:Label ID="Label3" runat="server" Text='<% #Bind("desig")%>'></asp:Label>
                                                    </p>
                                                    <p>
