<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="EmpAllow.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_85_Lon.EmpAllow" %>
                        ...
                        <asp:Panel ID="Panel4" runat="server">
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="style19">
                                        <asp:TextBox ID="txtMonth" runat="server" Width="100px" 
                                            MaxLength="6" BorderStyle="None"></asp:TextBox>
