...
namespace SPEWEB.F_81_Hrm.F_85_Lon
{
    public partial class EmpAllow : System.Web.UI.Page
    {
        ...
        private void GetDepartment()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE01", "GETDEPARTMENT", txtDepartment, "", "", "", "", "", "", "", "");
        ...
        private void ShowAllowance()
        {
            ...
            DataSet ds2 = HRData.GetTransInfo(comcod, "SP_ENTRY_EMPLOYEE01", "EMPALLOWANCE", Department, Monthid, "", "", "", "", "", "", "");
            if (ds2 == null)
            {
                this.gvEmpAllow.DataSource = null;
                this.gvEmpAllow.DataBind();
        ...
        protected void lUpdate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (overtime > 0 || Tiffin > 0 || holidays > 0 || Othersallow > 0 || dailyallow > 0 || cellphone > 0 || cellbill > 0 || a > 0 || b > 0)
                {
                    ...
                    bool result = HRData.UpdateTransInfo(comcod, "SP_ENTRY_EMPLOYEE01", "INSERTORDELETEALLOW", monthid, empid, overtime.ToString(), Tiffin.ToString(), holidays.ToString(), Othersallow.ToString(), dailyallow.ToString(), cellphone.ToString(), cellbill.ToString(), a.ToString(), b.ToString(), "", "", "", "");
                    if (!result)
                        return;
                }
            }
