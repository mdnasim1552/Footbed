    ...
    public partial class AccProFund : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "PROVIDENT FUND SCREEN VIEW/EDIT";
                this.txtpfMonth.Text = System.DateTime.Today.AddMonths(-1).ToString("yyyyMM");
        ...
        private void ShowPFInfo()
        {
            ...
            string Month = this.txtpfMonth.Text.Trim();
            string CompanyName = this.ddlCompany.SelectedValue.ToString().Substring(0, 2);


            DataSet ds5 = accData.GetTransInfo(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER", "PFACCOUNTINFO", Month, CompanyName, "", "", "", "", "", "", "");
            if (ds5 == null)
            {
                this.gvPfAcc.DataSource = null;
                this.gvPfAcc.DataBind();
        ...
        protected void lbtnFinalUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    bool resulta = accData.UpdateTransInfo(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER", "ACVUPDATE", vounum, sectionid, rescode, cactcode,
