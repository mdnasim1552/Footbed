...
namespace SPEWEB.F_81_Hrm.F_90_PF
{
    public partial class AccBankRecon : System.Web.UI.Page
    {
        ...
        protected void lbtnGetData_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds1 = accData.GetTransInfo(mCOMCOD, "dbo_hrm.SP_ENTRY_ACCOUNTS_VOUCHER", "SHOWBANKRECON",
        ...
        protected void btnGetDataP_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds1 = accData.GetTransInfo(mCOMCOD, "dbo_hrm.SP_REPORT_ACCOUNTS_TRANS", "PRINTBANKRECON",
                   mACCODE, mTRNDAT1, mTRNDAT2, "", "", "", "", "", "");
            if (ds1.Tables[0].Rows.Count == 0 || ds1 == null)
            {
                ((Label)this.Master.FindControl("lblmsg")).Text = "No Data Found";
        ...
        protected void lbtnGetBankList_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds1 = accData.GetTransInfo(mCOMCOD, "dbo_hrm.SP_ENTRY_ACCOUNTS_VOUCHER", "GETCONACCHEAD",
                   "", "", "", "", "", "", "", "", "");
            if (ds1.Tables[0].Rows.Count == 0 || ds1 == null)
            {
                ((Label)this.Master.FindControl("lblmsg")).Text = "No Data Found";
        ...
        protected void gv1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            //try
            {
                ...
                bool result = accData.UpdateTransInfo(mCOMCOD, "dbo_hrm.SP_ENTRY_ACCOUNTS_VOUCHER", "UPDATEBANKRECON",
