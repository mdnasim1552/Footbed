...
namespace SPEWEB.F_81_Hrm.F_91_ACR
{
    public partial class EmpEntryACR : System.Web.UI.Page
    {
        ...
        private void GetCompany()
        {
            ...
            DataSet ds5 = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "GETCOMPANYNAME", txtCompany, "", "", "", "", "", "", "", "");
        ...
        private void GetEmployeeName()
        {
            ...
            DataSet ds3 = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "GETEMPTNAME", Section, txtSProject, "", "", "", "", "", "", "");
        ...
        protected void lbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            ReportDocument rptempacr = new RMGiRPT.R_81_Hrm.R_91_ACR.RptEmpACR();
        ...
        private void Get_ACRsno()
        {
            ...
            if (aCRNo == "NEWACR")
            {
                DataSet ds3 = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "LASTACRNO", date, "", "", "", "", "", "", "", "");
                if (ds3 == null)
                    return;
        ...
        private void ShowACRInfo()
        {
            ...
            DataSet ds2 = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "EMPACRINFO", section, empid, "", "", "", "", "", "", "");
            if (ds2 == null)
                return;
        ...
        protected DataSet PreAcrInfo()
        {
            ...
            Hashtable hst = (Hashtable)Session["tblLogin"];
            string comcod = hst["comcod"].ToString();
            DataSet ds = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "PrevACRInfo", acrno, "", "", "", "", "", "", "", "");
            return ds;
        ...
        protected void lUpdatACRInfo_Click(object sender, EventArgs e)
        {
            ...
            bool result = HRData.UpdateTransInfo2(comcod, "SP_ENTRY_ACR_EMPLOYEE", "INSERTORUPDATEACRINFB", acrno, date, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
            if (result == false)
                return;
            ...
            for (int i = 0; i < this.gvACREntry.Rows.Count; i++)
            {
                ...
                HRData.UpdateTransInfo2(comcod, "SP_ENTRY_ACR_EMPLOYEE", "INSERTORUPDATEACRINFA", acrno, empid, Gcode, gdesc, evl1, evl2, evl3, "", "", "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        protected void Load_Prev_ACR_List()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "GetPrevACRList", curdate, "", "", "", "", "", "", "", "");
        ...
        private void SectionName()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_ENTRY_ACR_EMPLOYEE", "GETSECNAME", Company, txtSProject, "", "", "", "", "", "", "");
