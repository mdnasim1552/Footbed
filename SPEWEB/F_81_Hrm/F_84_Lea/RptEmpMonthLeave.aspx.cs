...
namespace SPEWEB.F_81_Hrm.F_84_Lea
{
    public partial class RptEmpMonthLeave : System.Web.UI.Page
    {
        ...
        private void GetCompany()
        {
            ...
            DataSet ds5 = HRData.GetTransInfo(comcod, "SP_REPORT_HR_ATTENDENCE", "GETCOMPANYNAME", txtCompany, userid, "", "", "", "", "", "", "");
        ...
        private void Show()
        {
            ...
            DataSet ds5 = HRData.GetTransInfo(comcod, "SP_REPORT_LEAVESTATUS", "RPTMONTHLYLEAVE", frmdat, todate, ddlcomp, "", "", "", "", "", "");
        ...
        protected void lbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = (DataTable)Session["tblleave"];
            ReportDocument rptcb1 = new RMGiRPT.R_81_Hrm.R_84_Lea.RptEmpMonthlyLeave();
