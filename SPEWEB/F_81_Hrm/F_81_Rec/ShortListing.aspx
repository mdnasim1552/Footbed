<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="ShortListing.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_81_Rec.ShortListing" %>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-md-8 col-sm-8 col-lg-8 pading5px">
                                        ...
                                        <cc1:CalendarExtender ID="txtCurAdvDate_CalendarExtender" runat="server" Format="dd-MMM-yyyy" TargetControlID="txtCurAdvDate"></cc1:CalendarExtender>
                                        ...
                                        <asp:DropDownList ID="ddlPOSTList" runat="server" Width="200px" CssClass="form-control inputTxt pull-left" TabIndex="2"></asp:DropDownList>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-lg-4 pading5px">
                                        ...
                                        <asp:DropDownList ID="ddlPrevlist" Visible="false" runat="server" AutoPostBack="true" Width="233" CssClass="form-control inputTxt pull-left" TabIndex="2" OnSelectedIndexChanged="ddlPrevlist_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <asp:GridView ID="gvSListInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Col1">
                                    <FooterTemplate>
                                        <asp:LinkButton ID="lbtnUpdateResReq" runat="server" Font-Bold="True" CssClass="btn btn-success primaryBtn" Visible="false" OnClick="lbtnUpdateResReq_Click" Style="text-align: center;"
                                    ...
                                    <ItemTemplate>
                                       ...
                                       <%-- <asp:TextBox ID="txtgvCol9" runat="server" CssClass="txtboxformat" Width="110px"></asp:TextBox>
                                        <cc1:CalendarExtender ID="txtgvCol9_CalendarExtender" runat="server"
                                         ...
                                         <asp:TextBox SkinID="txtboxCustomizedMfSkin" ID="txtgvCol9" Text='<%# (Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "col9")).Year==1900? "" :Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "col9")).ToString("dd-MMM-yyyy")) %>'  runat="server" Width="80px" CausesValidation="true"  />
                            ...
                            ControlToValidate="txtgvCol12" />--%>
                                ...
                                <asp:TemplateField HeaderText="CV">
                                    <ItemTemplate>
                                        ...
                                        <a href="<%# Eval("col20") %>" target="_blank">
                            ...
                            <div class="col-md-5 col-sm-5 col-lg-5">
                                <asp:Panel ID="PanelAddInt" runat="server">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                        <asp:DropDownList ID="ddlInterviewer" runat="server" Width="233" CssClass="form-control inputTxt pull-left chzn-select" TabIndex="2">
                                        </asp:DropDownList>
                                        </div>
                                        <div class="col-sm-4">
                                ...
                                <asp:GridView ID="gvIntInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Date of Interview" Visible="false">
                                            <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                               <%-- <asp:TextBox ID="txtgvIntDat" runat="server" BorderColor="#99CCFF" BorderStyle="Solid" Visible="false"
                                                ...
                                                <asp:TextBox SkinID="txtboxCustomizedMSkin" ID="txtgvIntDat" Text='<%# (Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "intdat")).Year==1900? "" :Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "intdat")).ToString("dd-MMM-yyyy")) %>' runat="server" CausesValidation="true" ReadOnly="true" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:Image ID="imgLoader" runat="server" Width="200px" Height="200px" ImageUrl="~/images/loader.gif" />
                                                </div>
                                            </div>
                                        </div>
