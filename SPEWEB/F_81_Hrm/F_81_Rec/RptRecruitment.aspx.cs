...
namespace SPEWEB.F_81_Hrm.F_81_Rec
{
    public partial class RptRecruitment : System.Web.UI.Page
    {
        ...
        private void PrintJobAdvertise()
        {
            ...
            ReportDocument rrs1 = new RMGiRPT.R_81_Hrm.R_81_Rec.RptJobAdvetise();
        ...
        private void PrintSortList()
        {
            ...
            DataTable dt1 = (DataTable)Session["tblrec"];
            ReportDocument rrs1 = new RMGiRPT.R_81_Hrm.R_81_Rec.RptSortList();
            TextObject rptCname = rrs1.ReportDefinition.ReportObjects["txtCompanyName"] as TextObject;
        ...
        private void PrintInterviewResult()
        {
            ...
            DataRow[] dr1 = (((DataTable)Session["tbladvno"]).Select("advno='" + advno + "'"));
            DataTable dt1 = (DataTable)Session["tblrec"];
            ReportDocument rrs1 = new RMGiRPT.R_81_Hrm.R_81_Rec.RptInterviewResult();
            TextObject rptCname = rrs1.ReportDefinition.ReportObjects["txtCompanyName"] as TextObject;
            rptCname.Text = dr1[0]["company"].ToString();
        ...
        private void PrintFinalSelect()
        {
            ...
            DataRow[] dr1 = (((DataTable)Session["tbladvno"]).Select("advno='" + advno + "'"));
            DataTable dt1 = (DataTable)Session["tblrec"];
            ReportDocument rrs1 = new RMGiRPT.R_81_Hrm.R_81_Rec.RptFinalSelection();
            TextObject rptCname = rrs1.ReportDefinition.ReportObjects["txtCompanyName"] as TextObject;
            rptCname.Text = dr1[0]["company"].ToString();
        ...
        private void ShowJObAdvertise()
        {
            ...
            string todate = Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");
            DataSet ds2 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_RECRUITMENT", "RPTJOBADVERTISEMENT", frmdate, todate, "", "", "", "", "", "", "");
            if (ds2 == null)
                return;
        ...
        protected void ShowSortList()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_RECRUITMENT", "SHOWSORTLIST", mADVNO, mPOST,
                      Type, "", "", "", "", "", "");
            if (ds1 == null)
            {
        ...
        private void GetAdvertise()
        {
            ...
            string frmdate = Convert.ToDateTime(this.txtfromdate.Text).ToString("dd-MMM-yyyy");
            string todate = Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_RECRUITMENT", "GETADVERTISENO", frmdate, todate,
                          refno, "", "", "", "", "", "");
            if (ds1 == null)
                return;
...

        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_RECRUITMENT", "GETADVPOST", Advno, mSrchTxt, "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
