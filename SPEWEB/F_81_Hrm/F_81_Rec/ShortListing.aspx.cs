    ...
    public partial class ShortListing : System.Web.UI.Page
    {
        ...
        protected void lbtnOk_Click(object sender, EventArgs e)
        {
            ...
            if (this.ddlPrevlist.Items.Count > 0)
            {
                ...
                this.lblPreAdvlist.Text = this.ddlPrevlist.SelectedItem.ToString().Trim();

            }
            else
            {
                this.lblPreAdvlist.Text = this.ddlPrevAdvList.SelectedItem.ToString().Trim();
        ...
        protected void GetAdvInfo()
        {
            ...
            if (this.ddlPrevlist.Items.Count > 0)
            {
                mADVNO = this.ddlPrevlist.SelectedValue.Substring(0, 12).ToString().Trim();
                mPOST = this.ddlPrevlist.SelectedValue.Substring(12, 5).ToString().Trim();
            ...
            {
                mADVNO = this.ddlPrevAdvList.SelectedValue.ToString().Trim();
                mPOST = this.ddlPOSTList.SelectedValue.ToString().Trim();
        ...
        protected void Get_SList_Info()
        {
            ...
            {
                mADVNO = this.ddlPrevlist.SelectedValue.Substring(0, 12).ToString().Trim();
                mPOST = this.ddlPrevlist.SelectedValue.Substring(12, 7).ToString().Trim();
        ...
        protected void lbtnUpdateResReq_Click(object sender, EventArgs e)
        {
            ...
            {
                mADVNO = this.ddlPrevlist.SelectedValue.Substring(0, 12).ToString().Trim();
                mPOSTCODE = this.ddlPrevlist.SelectedValue.Substring(12, 7).ToString().Trim();

            }
            else
            {
                mADVNO = this.ddlPrevAdvList.SelectedValue.ToString().Trim();
                mPOSTCODE = this.ddlPOSTList.SelectedValue.ToString().Trim();
            ...
            {
                string listisu = (tbl1.Rows[i]["listisu"]).ToString().Trim();
                string sendflag = (tbl1.Rows[i]["sendflag"]).ToString().Trim();
            ...
            {
                ((Label)this.Master.FindControl("lblmsg")).Text = "please select Interviewer";
                ((Label)this.Master.FindControl("lblmsg")).Attributes.Add("style", "color:#fff;font-weight:bold; background:red");
                return;
            }
        ...
        protected void lbSelection_Click(object sender, EventArgs e)
        {
            ...
            string postcode = code.Substring(0, 7).ToString().Trim();
            string slnum = code.Substring(7, 9).ToString().Trim();
            string mADVNO = this.ddlPrevAdvList.SelectedValue.ToString().Trim();
            DataTable dt = (DataTable)ViewState["tbSList"];
           ...
           ((Label)this.Master.FindControl("lblmsg")).Text = "Selection Successfully.";
        ...
        protected void FileUploadComplete(object sender, AsyncFileUploadEventArgs e)
        {
            ...
            if (AsyncFileUpload1.HasFile)
            {
                ...
                Url = empid + "_" + candName + extension;

                bool result = RecData.UpdateTransInfo(comcod, "dbo_hrm.SP_ENTRY_ADVERTISEMENT", "UPLOADECANDIDATECV", mADVNO, mPOSTCODE, empid, Url, "", "", "", "", "",
                            "", "", "", "", "", "");
                if (result == true)
                {
                    ((Label)this.Master.FindControl("lblmsg")).Text = "CV Uploded";


                }
                else
                {
                    ((Label)this.Master.FindControl("lblmsg")).Text = "Uploded fail";
