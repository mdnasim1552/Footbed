...
{
    public partial class RecAccSubCodeBook : System.Web.UI.Page
    {
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_RECRUITMENT", "OACCOUNTCODE", "",
                                "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                if (updateallow)
                {
                    ...
                    bool result = this.da.UpdateTransInfo(comcod, "SP_ENTRY_RECRUITMENT", "OACCOUNTUPDATE", sircode2.Substring(0, 2), sircode, Desc, txtsirtype, txtsirtdesc, txtsirunit, txtsirval, "", "", "",
                        "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_RECRUITMENT", "OACCOUNTINFO", tempddl1,
                                  tempddl2, srchoption, "", "", "", "", "", "");
            if (ds1 == null)
            {
                this.grvacc.DataSource = null;
