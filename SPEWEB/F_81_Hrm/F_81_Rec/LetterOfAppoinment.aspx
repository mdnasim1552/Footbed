<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="LetterOfAppoinment.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_81_Rec.LetterOfAppoinment" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px">
                                        <asp:DropDownList ID="ddlPrevAdvList" runat="server" Width="233" CssClass="form-control inputTxt pull-left chzn-select" TabIndex="2">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px  ">
                                        <asp:DropDownList ID="ddlPOSTList" runat="server" Width="233" CssClass="form-control inputTxt pull-left chzn-select" TabIndex="2">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 pading5px asitCol4">
                                        <asp:DropDownList ID="ddlCanList" runat="server" Width="233" CssClass="form-control inputTxt pull-left chzn-select" TabIndex="2">
                                        </asp:DropDownList>
                                    ...
                                    <div class="col-md-4 pading5px asitCol4">
                                        ...
                                        <asp:RadioButtonList ID="rbtnFont" runat="server" style="font-size:12px;"  CssClass="rbtnList1 margin5px">
                                            <asp:ListItem Value="EN" Selected="True">English</asp:ListItem>
                                            <asp:ListItem Value="BN">বাংলা</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0101001" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
...
Ref: HRD/LOA/2014/XX   
                                ...
                                <tr>
                                    <td class="style16"></td>
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0101002" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
...
Address: XXX
                                ...
                                <tr>
                                    <td class="style16"></td>
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0101003" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
...
With reference to your application and subsequent interview, the Management is pleased to appoint you as Manager in the department of Accounting under Noname Development Ltd.  with effect from March xxx, 2014 on the following terms and conditions</asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102001" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102002" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102003" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    <td class="style16">
                                        <asp:Label ID="TextBox1" runat="server"  Font-Bold="True" Font-Size="12px"
                                            Height="100px" Style="text-align: right" Width="90px">4.  </asp:Label>
                                    </td>
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102004" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102005" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102006" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102007" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102008" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102009" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102010" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102011" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102012" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102013" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    ...
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0102014" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                                ...
                                <tr>
                                    <td class="style16"></td>
                                    <td class="style26" colspan="8">
                                        <asp:TextBox ID="txt0201001" runat="server" BorderWidth="1px" Font-Bold="True" Font-Size="12px"
                    ...
                    <tr>
                        ...
                        <td class="style43">
                            ...
                            <asp:Label ID="lblPreAdvlist" runat="server" __designer:wfdid="w4" BackColor="White"
                                Font-Bold="True" Font-Size="12px" ForeColor="Maroon" Style="font-size: 12px;
                    ...
                    <tr>
                        ...
                        <td class="style43">
                            ...
                            <asp:Label ID="lblCan" runat="server" __designer:wfdid="w4" BackColor="White" Font-Bold="True"
                                Font-Size="12px" ForeColor="Maroon" Style="font-size: 12px; text-align: left"
