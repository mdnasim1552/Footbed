...
namespace SPEWEB.F_81_Hrm.F_81_Rec
{
    public partial class RptShortListing : System.Web.UI.Page
    {
        ...
        protected void Get_SList_Info()
        {
            ...
            DataSet ds1 = RecData.GetTransInfo(comcod, "SP_ENTRY_ADVERTISEMENT", "SHOWSHOETLIST", mADVNO, mPOST,
                      "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void ImgbtnFindPost_Click(object sender, ImageClickEventArgs e)
        {
            ...
            DataSet ds1 = RecData.GetTransInfo(comcod, "SP_ENTRY_ADVERTISEMENT", "GETADVPOST", mProject, mSrchTxt, "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
