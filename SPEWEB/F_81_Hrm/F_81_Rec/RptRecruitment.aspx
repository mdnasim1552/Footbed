<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptRecruitment.aspx.cs" Inherits="SPEWEB.F_81_Hrm.F_81_Rec.RptRecruitment" %>
                                ...
                                <div class="form-group">
                                    <div class="col-md-5  pading5px"> 
                                        <asp:TextBox ID="txtSrchPre" runat="server" AutoCompleteType="Disabled"
                                            CssClass="inputtextbox hidden"></asp:TextBox>

                                       <asp:LinkButton ID="ImgbtnFindAdv" runat="server" CssClass="lblTxt lblName" OnClick="ImgbtnFindAdv_Click">ADV List</asp:LinkButton>

                                        <asp:DropDownList ID="ddlAdvList" runat="server" AutoPostBack="True" CssClass="ddlPage chzn-select" Width="250"
