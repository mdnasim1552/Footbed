    ...
    public partial class RatioAnaWithGraph : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = (this.Request.QueryString["grp"] == "01") ? "Liquidety Ratio Analysis With Graph"
                    : (this.Request.QueryString["grp"] == "02") ? "Financial Leveragde Analysis With Graph"
                    : (this.Request.QueryString["grp"] == "03") ? "Profitability Ratio Analysis With Graph"
                    : (this.Request.QueryString["grp"] == "04") ? "Dividend Policey Analysis With Graph"
                    : (this.Request.QueryString["grp"] == "05") ? "Turn Over Ratio Analysis With Graph" : "Ratio Analysis With Graph";
        ...
        private void ShowGraph()
        {
            ...
            var lst = dt.DataTableToList<SPEENTITY.C_31_Mis.UserManageMis.RatioAnalysis>();
        ...
        private void PrintRatio()
        {
            ...
            //var lst = dt.DataTableToList<SPEENTITY.C_17_Acc.EClassDB_BO.AccRatioAnalysis>();
