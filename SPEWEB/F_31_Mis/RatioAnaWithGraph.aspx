<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="RatioAnaWithGraph.aspx.cs" Inherits="SPEWEB.F_31_Mis.RatioAnaWithGraph" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript" >
        ...
        function ExecuteGraph(graphdata) {
           // alert("sfsfsf");
            console.log(graphdata);
            //var alldata = bgd;
           
            var bgddata = JSON.parse(graphdata);
