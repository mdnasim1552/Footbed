...
{
    public partial class LinkRptExPlVsAchivSumm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.lblLCName.Text = this.Request.QueryString["mlcdesc"].ToString();
        ...
        private void ShowPlanVsAch()
        {
            ...
            string ordercode = this.Request.QueryString["mlccod"].ToString();
            string date = this.Request.QueryString["Date"].ToString();
            DataSet ds1 = Data.GetTransInfo(comcod, "SP_REPORT_EXPORT_PLAN", "RPTEXPLNVSACHIV", ordercode, date, "", "", "", "", "", "", "");
        ...
        private void GetOrderName()
        {
            ...
            DataSet ds1 = Data.GetTransInfo(comcod, "SP_REPORT_ORDER_STATUS", "GETORDER", "", "", "", "", "", "", "", "", "");
        ...
        private void LoadDetailsData()
        {
            ...
            DataSet ds1 = Data.GetTransInfo(comcod, "SP_REPORT_EXPORT_PLAN", "RPTEXPLNVSACHIVSUM", "", "", "", "", "", "", "", "", "");
        ...
        private void FooterCalculation(string GrView, DataTable dt)
        {
            ...
            switch (GrView)
            {
                ...
                case "gv_OrDer":
                    ...
                    HyperLink LcName = (HyperLink)this.gvOrDer.FooterRow.FindControl("hlnkDetails");

                    string mlccod = this.Request.QueryString["mlccod"].ToString();
                    string mlcdesc = this.Request.QueryString["mlcdesc"].ToString();

                    LcName.NavigateUrl = "~/F_05_ProShip/LinkRptExPlanAchiv.aspx?mlccod=" + mlccod + "&mlcdesc=" + mlcdesc + "&Date=" + this.Request.QueryString["Date"].ToString();
        ...
        private DataTable HiddenSameData(DataTable dt1, string GrView)
        {
            ...
            switch (GrView)
            {
                ...
                case "gv_instment":
                    ...
                    for (int j = 1; j < dt1.Rows.Count; j++)
                    {
                        if (dt1.Rows[j]["mgrp"].ToString() == mgrp && dt1.Rows[j]["grp"].ToString() == grp)
                        {
        ...
        protected void gvinstment_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (ASTUtility.Right(code, 3) == "000")
                {
                    ...
                    BalAmt.Font.Bold = true;
                    groupdesc.Style.Add("text-align", "right");
                    groupdesc.Attributes["style"] = "background-color:blue; color:white;";
