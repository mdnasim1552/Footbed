...
{
    public partial class BgdCodeBook : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Anual Business Planning Code";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETCODEBOOK", "",
                                "", "", "", "", "", "", "", "");
                this.ddlOthersBook.DataTextField = "resdesc";
                this.ddlOthersBook.DataValueField = "rescode";
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string tgcod = gcode1.Substring(0, 2) + ASTUtility.Left(gcode2, 3) + ASTUtility.Right(gcode2, 3);
            string gdesc = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvDesc")).Text.Trim();
            string gUnit = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvttpe")).Text.Trim();
            string Rate = Convert.ToDouble("0" + ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvrate")).Text.Trim()).ToString();



            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "INSERTUPBGDGINF", tgcod,
                           gdesc, gUnit, Rate, "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "SHOWGRIDDATA", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
