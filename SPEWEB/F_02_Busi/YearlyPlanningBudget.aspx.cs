    ...
    public partial class YearlyPlanningBudget : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = (type == "Yearly") ? "Yearly Revenue Target/Cost Entry"
        ...
        protected void gvySalbgd_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (code == "01001001")
                {
                    ...
                    hlink1.NavigateUrl = "~/F_19_EXP/MonthlySalesBudget.aspx?Type=Monthly";
                ...
                if (code == "01003001")
                {
                    ...
                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=55010001";

                }
                else if (code == "01003002")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=55010010";

                }
                else if (code == "01003003")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=6101";

                }
                else if (code == "01003004")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=6102";

                }
                else if (code == "01004001")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=9101";

                }
                else if (code == "01004002")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=9102";

                }
                else if (code == "01004003")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=7101";

                }
                else if (code == "01004004")
                {
                    hlink1.Style.Add("color", "blue");

                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=Type=All&rType&rType=9103";
                ...
                else if (code == "01005001")
                {
                    ...
                    hlink1.NavigateUrl = "~/F_17_Acc/AccMonthlyBgd.aspx?Type=All&rType=8101";
