...
namespace SPEWEB
{
    public partial class StepofOperation : System.Web.UI.Page
    {
        ...
        private void ModuleVisible()
        {
            ...
            //this.ddlModuleName.Items[26].Enabled = (((CompType == "5") && (commod == "1"))  && (Convert.ToBoolean(dt.Rows[26]["usrper"])) && (Convert.ToBoolean(dt.Rows[26]["flag"])));
            //this.ddlModuleName.Items[27].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[27]["usrper"])) && (Convert.ToBoolean(dt.Rows[27]["flag"])));
            //this.ddlModuleName.Items[28].Enabled = true;

            //this.ddlModuleName.Items[28].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[28]["usrper"])) && (Convert.ToBoolean(dt.Rows[28]["flag"])));
            //this.ddlModuleName.Items[29].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[29]["usrper"])) && (Convert.ToBoolean(dt.Rows[29]["flag"])));
            //this.ddlModuleName.Items[30].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[30]["usrper"])) && (Convert.ToBoolean(dt.Rows[30]["flag"])));

            //this.ddlModuleName.Items[31].Enabled = true;
            //this.ddlModuleName.Items[32].Enabled = true;\

            //Above Change

            //this.ddlModuleName.Items[31].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[31]["usrper"])) && (Convert.ToBoolean(dt.Rows[31]["flag"])));
            //this.ddlModuleName.Items[32].Enabled = (((CompType == "5") && (commod == "1")) && ((Convert.ToBoolean(dt.Rows[32]["usrper"])) && (Convert.ToBoolean(dt.Rows[32]["flag"]))));



            //this.ddlModuleName.Items[33].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[33]["usrper"])) && (Convert.ToBoolean(dt.Rows[33]["flag"])));
            //this.ddlModuleName.Items[34].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[34]["usrper"])) && (Convert.ToBoolean(dt.Rows[34]["flag"])));
            //this.ddlModuleName.Items[35].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[35]["usrper"])) && (Convert.ToBoolean(dt.Rows[35]["flag"])));
            //this.ddlModuleName.Items[36].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[36]["usrper"])) && (Convert.ToBoolean(dt.Rows[36]["flag"])));
            //this.ddlModuleName.Items[37].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[37]["usrper"])) && (Convert.ToBoolean(dt.Rows[37]["flag"])));
            //this.ddlModuleName.Items[38].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[38]["usrper"])) && (Convert.ToBoolean(dt.Rows[38]["flag"])));
            //this.ddlModuleName.Items[39].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[39]["usrper"])) && (Convert.ToBoolean(dt.Rows[39]["flag"])));
            //this.ddlModuleName.Items[40].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[40]["usrper"])) && (Convert.ToBoolean(dt.Rows[40]["flag"])));
            //this.ddlModuleName.Items[41].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[41]["usrper"])) && (Convert.ToBoolean(dt.Rows[41]["flag"])));
            //this.ddlModuleName.Items[42].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[42]["usrper"])) && (Convert.ToBoolean(dt.Rows[42]["flag"])));
            //this.ddlModuleName.Items[43].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[43]["usrper"])) && (Convert.ToBoolean(dt.Rows[43]["flag"])));
            //this.ddlModuleName.Items[44].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[44]["usrper"])) && (Convert.ToBoolean(dt.Rows[44]["flag"])));
            //this.ddlModuleName.Items[45].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[45]["usrper"])) && (Convert.ToBoolean(dt.Rows[45]["flag"])));
            //this.ddlModuleName.Items[46].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[46]["usrper"])) && (Convert.ToBoolean(dt.Rows[46]["flag"])));
            //this.ddlModuleName.Items[47].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[47]["usrper"])) && (Convert.ToBoolean(dt.Rows[47]["flag"])));
            //this.ddlModuleName.Items[48].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[48]["usrper"])) && (Convert.ToBoolean(dt.Rows[48]["flag"])));
            //this.ddlModuleName.Items[49].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[49]["usrper"])) && (Convert.ToBoolean(dt.Rows[49]["flag"])));
            //this.ddlModuleName.Items[50].Enabled = (((CompType == "5") && (commod == "1")) && (Convert.ToBoolean(dt.Rows[50]["usrper"])) && (Convert.ToBoolean(dt.Rows[50]["flag"])));




            //this.ddlModuleName.Items[0].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[1].Enabled = ((CompType == "5") && (commod == "1"));
            //this.ddlModuleName.Items[2].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[3].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[4].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[5].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[6].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[7].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[8].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[9].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[10].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[11].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[12].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[13].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[14].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[15].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[16].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[17].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[18].Enabled = ((CompType == "5") && (commod == "1")) ;



            // this.ddlModuleName.Items[19].Enabled = ((CompType == "5") && (commod == "1")) ;
            // this.ddlModuleName.Items[20].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[21].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[22].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[23].Enabled = ((CompType == "5") && (commod == "1")) ;
            //this.ddlModuleName.Items[24].Enabled = ((CompType == "8") && (commod == "1")) ;
            //this.ddlModuleName.Items[25].Enabled = ((CompType == "8") && (commod == "1")) ;
            //this.ddlModuleName.Items[26].Enabled = ((CompType == "5") && (commod == "3")) ;
            //  this.ddlModuleName.Items[27].Enabled = ((CompType == "5") && (commod == "3")) ;
            // this.ddlModuleName.Items[28].Enabled = ((CompType == "5") && (commod == "3")) ;
            // this.ddlModuleName.Items[29].Enabled = ((CompType == "5") && (commod == "3")) ;
            //this.ddlModuleName.Items[30].Enabled = ((CompType == "5") && (commod == "3")) ;
