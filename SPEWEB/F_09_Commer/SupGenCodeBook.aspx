<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="SupGenCodeBook.aspx.cs" Inherits="SPEWEB.F_09_Commer.SupGenCodeBook" %>
        ...
        <tr>
            <td class="style18">
                <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="18px" 
                    ForeColor="Yellow" Text="SUPPLIER INFORMATION FIELD VIEW/EDIT" Width="618px"
