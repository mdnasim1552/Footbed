...
namespace SPEWEB.F_09_Commer
{
    public partial class LCAllInfo : System.Web.UI.Page
    {
        ...
        private void CommonButton()
        {
            ...
            ((LinkButton)this.Master.FindControl("lnkbtnAdd")).Attributes.Add("href", "../F_09_Commer/LCOpening?Type=Open&genno=&actcode=&dayid=");
        ...
        private void GetLcType()
        {
            ...
            DataSet ds2 = SalesData.GetTransInfo(comcod, "SP_ENTRY_LC_INFO", "GETLCTYPE", "", "", "", "", "", "", "", "", "");
        ...
        private void Print_LCAll()
        {
            try
            {
                ...
                var lst = (List<SPEENTITY.C_09_Commer.BO_AllLCInfo.AllLCInfolist>)ViewState["tblgltransection"];

                LocalReport rpt1 = new LocalReport();

                rpt1 = RptSetupClass.GetLocalReport("R_09_Commer.RptLCAllInfo", lst, "", "");
                rpt1.EnableExternalImages = true;
                rpt1.SetParameters(new ReportParameter("comnam", comnam));
                rpt1.SetParameters(new ReportParameter("comadd", comadd));
                rpt1.SetParameters(new ReportParameter("comLogo", comLogo));
                rpt1.SetParameters(new ReportParameter("rpttitle", "LC All Info"));
                ...
                //ReportDocument rptChallan = new RMGiRPT.R_21_Mkt.RptSalesOrder();
        ...
        {
            string comcod = this.GetCompCode();
            ((Label)this.Master.FindControl("lblprintstk")).Text = @"<script>window.open('RptAccVouher?vounum=" + actcode + "&comcod=" + comcod + "', target='_blank');</script>";
        ...
        protected void lnkbtnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (orderno.Length != 0)
                    ((Label)this.Master.FindControl("lblprintstk")).Text = @"<script>window.open('AccInv?Type=Edit" + "&vounum=" + actcode + "', target='_self');</script>";
            }
        }
        ...
        protected void lnkbtnAdd_Click1(object sender, EventArgs e)
        {
            ...
            if (qType == "All")
            {
                ((Label)this.Master.FindControl("lblprintstk")).Text = @"<script>window.open('../F_09_Commer/LCInformation?tname=order&tid=lc" + "', target='_self');</script>";
            }
