...
{
    public partial class KpiCodeBook : System.Web.UI.Page
    {
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "LANDOWCODE", qtype,
                                    "", "", "", "", "", "", "", "");
                this.ddlOthersBook.DataTextField = "kpigdesc";
                this.ddlOthersBook.DataValueField = "kpigcod";
        ...
        protected void grvacc_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            string code = ((DataTable)Session["storedata"]).Rows[rowindex]["kpigcod"].ToString();
            string gcode = ((TextBox)grvacc.Rows[e.NewEditIndex].FindControl("lbgrcod4")).Text.Trim().Replace("-", "");

            string gcode2 = ASTUtility.Right(((TextBox)grvacc.Rows[e.NewEditIndex].FindControl("lbgrcod4")).Text.Trim().Replace("-", ""), 3);
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string gcode2 = ((TextBox)grvacc.Rows[e.RowIndex].FindControl("lbgrcod4")).Text.Trim().Replace("-", "");
            if (gcode2 != "00000")
            {
            ...
            string stdqty = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvstdqty")).Text.Trim();
            string gmark = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvgmark")).Text.Trim();
            string status = ((DropDownList)this.grvacc.Rows[e.RowIndex].FindControl("ddlSData")).SelectedValue.Trim();

            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "INSERTUPPRINF", tgcod,
                           gdesc, "", stdqty, gmark, "", status, "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string Code = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "kpigcod")).ToString();
