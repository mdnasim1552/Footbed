<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="KpiCodeBook.aspx.cs" Inherits="SPEWEB.F_47_Kpi.KpiCodeBook" %>
            ...
            <div class="card card-fluid">
                <div class="card-body" style="min-height: 850px;">
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <asp:LinkButton ID="lnkok" runat="server" CssClass="margin-top30px btn btn-sm btn-primary" OnClick="lnkok_Click">Ok</asp:LinkButton>
                    ...
                    <asp:GridView ID="grvacc" runat="server" CssClass=" table-condensed table-hover table-bordered grvContentarea"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Code">
                                <EditItemTemplate>
                                    <asp:TextBox ID="lbgrcod4" runat="server" Font-Size="12px" Height="16px"
                                        MaxLength="6"
                            ...
                            <asp:TemplateField HeaderText="Description of Code">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtgvDesc" runat="server" Font-Size="12px" MaxLength="100"
                                        Style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; font-size: 12px; border-left-color: midnightblue; border-bottom-color: midnightblue; border-top-color: midnightblue; border-right-color: midnightblue;"
                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "kpigdesc")) %>'
                            ...
                            <asp:TemplateField HeaderText="Qty">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtgvstdqty" runat="server" Font-Size="12px" MaxLength="100"
                                        Style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; font-size: 12px; border-left-color: midnightblue; border-bottom-color: midnightblue; border-top-color: midnightblue; border-right-color: midnightblue;text-align:right"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "stdqty")).ToString("#,##0.00;-#,##0.00; ") %>'
                                        Width="100px"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblstdqty" runat="server" Font-Size="12px"
                                        Style="font-size: 12px"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "stdqty")).ToString("#,##0.00;-#,##0.00; ") %>'
                                        Width="100px"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Size="16px" HorizontalAlign="Right" />
                                <ItemStyle Font-Size="12px" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Mark">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtgvgmark" runat="server" Font-Size="12px" MaxLength="100"
                                        Style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; font-size: 12px; border-left-color: midnightblue; border-bottom-color: midnightblue; border-top-color: midnightblue; border-right-color: midnightblue; text-align:right"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "gmark")).ToString("#,##0.00;-#,##0.00; ")  %>'
                                        Width="100px" ></asp:TextBox>
                                </EditItemTemplate>

                                <ItemTemplate>
                                    <asp:Label ID="lblgmark" runat="server" Font-Size="12px"
                                        Style="font-size: 12px"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "gmark")).ToString("#,##0.00;-#,##0; ")  %>'
                                        Width="100px"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Font-Size="16px" HorizontalAlign="Right" />
                                <ItemStyle Font-Size="12px" HorizontalAlign="Right" />
                             ...
                             <asp:TemplateField HeaderText="Status">
                                <EditItemTemplate>
                                     <asp:Panel ID="txtgvactive" runat="server">
                                        <table style="width: 100%;">
                                            <tr>

                                                <td>
                                                    <div class="col-md-4 pading5px">
                                                        <asp:DropDownList ID="ddlSData" runat="server" CssClass="form-control inputTxt chzn-select" Width="100px">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblactive" runat="server" Font-Size="12px"
                                        Style="font-size: 12px"
                            ...
                            <asp:TemplateField HeaderText="Hidden Column" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lbgrcod1" runat="server"
                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "kpigcod")) %>'
