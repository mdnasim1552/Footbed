    ...
    public partial class AccOnlinePaymnt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Proposal Bill Entry";
        ...
        private void GetBillNo()
        {
            try
            {
                ...
                DataSet ds1 = accData.GetTransInfo(comcod, "SP_ENTRY_ACCOUNTS_ONLINE_PAYMENT", "GETBILLNO", ttsrch, searchbill, "", fDate, tDate, "", "", "", "");
        ...
        private void GetSelectedBillNo()
        {
            ...
            this.GetBillNo();
            DataTable dt2 = ((DataTable)Session["BillAmt"]).Copy();
            ...
            if (valfield1 == "GBL")
            {
                ...
                dv1.RowFilter = ("valfield1 ='" + valfield1 + "'");
            ...
            else
            {
                ...
                if (ssircode == "990000000000")
                {
                    dv.RowFilter = ("sircode like '" + supasub + "%'");
                    dv1.RowFilter = ("sircode like '" + supasub + "%'");


                }

                else if (ssircode == "980000000000")
                {
                ...
                else
                {
                    ...
                    dv1.RowFilter = ("sircode ='" + ssircode + "'");
                }
            }
            //else
            //{
                ...
                foreach (DataRow dr in dt1.Rows)
                {
                    ...
                    if (amt > 0)
                    {
                        result = accData.UpdateTransInfo2(comcod, "SP_ENTRY_ACCOUNTS_ONLINE_PAYMENT", "INSERTORUPONLINEPAY", slnum, rcvdate, refno, actcode, paycode, billnature, amt.ToString(),
                                                                   apppaydate, rescode, billno, advamt.ToString(), valdate, userid, Terminal, Sessionid, mslnum, billamt, "", "", "", "");
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "CallMyFunction", "showContentFail('Bill Amount Empty');", true);
                    }
