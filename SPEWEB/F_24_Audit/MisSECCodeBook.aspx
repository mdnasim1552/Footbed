<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="MisSECCodeBook.aspx.cs" Inherits="SPEWEB.F_24_Audit.MisSECCodeBook" %>
    ...
    <table style="width: 912px">
            <tr>
                ...
                <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="18px" 
                    ForeColor="Yellow" Text="SECURITY & EXCHANES COMMISION CODE" Width="500px"
                                                                ...
                                                                <asp:TemplateField HeaderText=" ">
                                                                    <EditItemTemplate>
                                                                        <asp:Label ID="lbgvcode" runat="server" ForeColor="Black" 
                                                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "seccode2"))+"-" %>' 
                                                                ...
                                                                <asp:TemplateField HeaderText="Code">
                                                                    <EditItemTemplate>
                                                                        <asp:TextBox ID="txtgvcode3" runat="server" Height="16px" MaxLength="6" 
                                                                            ...
                                                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "seccode3")) %>' 
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Condition #">
                                                                    <EditItemTemplate>
                                                                        <asp:TextBox ID="txtgvconno" runat="server" Height="16px" 
                                                                            style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none; font-size: 12px; border-left-color: midnightblue; border-bottom-color: midnightblue; border-top-color: midnightblue; border-right-color: midnightblue;" 
                                                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "conno")) %>' 
                                                                            Width="70px"></asp:TextBox>
                                                                    </EditItemTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblgvconno" runat="server" ForeColor="Black" 
                                                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "conno")) %>' 
