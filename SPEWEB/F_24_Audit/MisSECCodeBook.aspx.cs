...
namespace SPEWEB.F_24_Audit
{
    public partial class MisSECCodeBook : System.Web.UI.Page
    {
        ...
        private void ShowLetterInfo()
        {
            ...
            DataSet ds1 = this.accData.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "SECGINFO", "", "", "", "", "", "", "", "", "");
            if (ds1 == null)
            {
        ...
        protected void gvnoteinfo_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                string conno = ((TextBox)gvnoteinfo.Rows[e.RowIndex].FindControl("txtgvconno")).Text.Trim();
                ...
                bool result = this.accData.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "INORUPSECGINF", Code, Desc, conno, "", "", "", "", "", "", "", "", "", "", "", "");
                this.gvnoteinfo.EditIndex = -1;
