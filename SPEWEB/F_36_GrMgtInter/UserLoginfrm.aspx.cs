...
namespace SPEWEB.F_36_GrMgtInter
{
    public partial class UserLoginfrm : System.Web.UI.Page
    {
        ...
        private void ShowUserInfo()
        {
            ...
            DataSet ds1 = User.GetTransInfo(comcod, "SP_UTILITY_LOGIN_MGT", "SHOWMGTUSER", SearcUser, "", "", "", "", "", "", "", "");
            if (ds1 == null)
            {
        ...
        protected void lbtnUserId_Click(object sender, EventArgs e)
        {
            ...
            ///-------------------------///////////
            string modname = "46%";
            DataSet ds2 = User.GetTransInfo(comcod, "SP_UTILITY_LOGIN_MGT", "SHOWMODWISEFORM", usrid, modname, "", "", "", "", "", "", "");
            if (ds2 == null)
            {
