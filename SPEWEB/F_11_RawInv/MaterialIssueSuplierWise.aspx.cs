...
{
    public partial class MaterialIssueSuplierWise : System.Web.UI.Page
    {
        ...
        protected void lbtnOk_Click(object sender, EventArgs e)
        {
            ...
            this.lblCurNo1.Text = "ISU00-";
            this.lblCurNo2.Text = "00000";
        ...
        private void ShowIsuInfo()
        {
            ...
            DataSet ds1 = PurData.GetTransInfo(comcod, "SP_ENTRY_MATERIAL_ISSUE", "GET_MAT_ISSUE_INFO", mReqNo, CurDate1,
                      "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void lbtnSelectReqList_Click(object sender, EventArgs e)
        {
            ...
            dt2 = dv.ToTable();
            DataRow[] dr3 = dt2.Select("rsircode='" + matcod + "' and spcfcod='" + spcfcod + "' and procode='" + process + "' and ssircode='"+ ssircode + "'");

            DataRow[] dr4 = tbl1.Select("rsircode='" + matcod + "' and spcfcod='" + spcfcod + "' and procode='" + process + "' and ssircode='" + ssircode + "'");
            if (dr4.Length > 0)
            {
                if (dr4[0]["rsircode"].ToString() == matcod && dr4[0]["spcfocd"].ToString() == spcfcod)
                {
                    return;
                }
            }
            else
            {
                ...
                dr1["ssircode"] = dr3[0]["ssircode"].ToString();
                dr1["ssirdesc"] = dr3[0]["ssirdesc"].ToString();
                tbl1.Rows.Add(dr1);
            }
        ...
        protected void ImgbtnFindReqList_Click(object sender, EventArgs e)
        {
         ...
         //   string CallType = Dprno.Substring(0, 3) == "SDL" ? "MATCODELISTSAMPLING" : "MATCODELIST";
            DataSet ds1 = PurData.GetTransInfo(comcod, "SP_ENTRY_MATERIAL_ISSUE", "SUP_WISE_MATERIAL_LIST", iStore, iDate, SearchInfo, Dprno, reqtype, isunum, "", "", "");
            if (ds1 == null)
                return;
           ...
           DataTable dt2 = ds1.Tables[0].DefaultView.ToTable(true, "ssirdesc", "ssircode");
            dt2.Rows.Add("None", "000000000000");
            this.DdlSupplier.DataTextField = "ssirdesc";
            this.DdlSupplier.DataValueField = "ssircode";
            this.DdlSupplier.DataSource = dt2;
        ...
        protected void lbtnFinalProUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    double isuamt = isuqty * Convert.ToDouble(dt.Rows[i]["isurate"].ToString());
                    ...
                    if (isuqty > 0)
                    {
                        result = PurData.UpdateTransInfo(comcod, "SP_ENTRY_LCMATISSUE", "UPDATEPURMISSUEINFO", "MATISSUEA", misuno, preqno, orderno, rsircode, isuqty.ToString(), spcfcod, conunt, conqty.ToString(), storeid, procode, isuamt.ToString(), ssircode, "");
                        if (!result)
                            return;
                    }
        ...
        protected void DdlSupplier_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dv.RowFilter = ("ssircode='" + suplier + "'");
            dt2 = dv.ToTable(true, "preqno2", "preqno");           
            // Session["tblMatIssue"] = dt2;
            this.ddlReqList.DataTextField = "preqno2";
            this.ddlReqList.DataValueField = "preqno";
            this.ddlReqList.DataSource = dt2; // ds1.Tables[1];
            this.ddlReqList.DataBind();
            ddlReqList_SelectedIndexChanged(null, null);
        }
        protected void ddlReqList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt2 = new DataTable();
            DataView dv = dt1.DefaultView;
            dv.RowFilter = ("preqno='" + mReqno + "' and ssircode='"+ supplier + "'");
        ...
        protected void lnkSelectAll_Click(object sender, EventArgs e)
        {
            ...
            DataRow[] dr3 = tbl2.Select("preqno='" + mReqno + "' and ssircode='"+ssircode+"'");
            DataView dv = tbl2.DefaultView;
            dv.RowFilter = "procode like '" + process + "' and ssircode='" + ssircode + "'"; //and ssircode='" + ssircode + "'
            tbl2 = dv.ToTable();


            for (int i = 0; i < tbl2.Rows.Count; i++)
            {
                DataRow[] dr2 = tbl1.Select("preqno='" + mReqno + "' and rsircode = '" + tbl2.Rows[i]["rsircode"].ToString() + "' and spcfcod='" + tbl2.Rows[i]["spcfcod"].ToString() + "' and procode='" + tbl2.Rows[i]["procode"].ToString() + "' and ssircode='" + tbl2.Rows[i]["ssircode"].ToString() + "'");
                if (dr2.Length == 0)
                {
                    DataRow dr1 = tbl1.NewRow();
                    ...
                    dr1["ssircode"] = tbl2.Rows[i]["ssircode"].ToString();
                    dr1["ssirdesc"] = tbl2.Rows[i]["ssirdesc"].ToString();
        ...
        protected void ddlprocess_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt2 = new DataTable();
            DataView dv = dt1.DefaultView;
            dv.RowFilter = ("preqno='" + mReqno + "' and procode like '" + process + "%' and ssircode='"+ ssircode + "'");
            //  dt2 = dv.ToTable();
        ...
        protected void ddlMatList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dv2.RowFilter = ("preqno='" + mReqno + "' and procode like '" + process + "' and rsircode='" + mResCode + "' and ssircode='"+ ssircode + "'");
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "CallMyFunction", "showContentFail('Not set Material Unit or Stock out');", true);
        ...
        protected void ModalUpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "CallMyFunction", "showContent('Data Updated');", true);
