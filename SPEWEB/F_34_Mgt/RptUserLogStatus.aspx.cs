...
namespace SPEWEB.F_34_Mgt
{
    public partial class RptUserLogStatus : System.Web.UI.Page
    {
        ...
        private void UserLogStatus()
        {
            ...
            DataSet ds1 = _LogRecord.GetTransInfo(comcod, "SP_ENTRY_EVENTLOG", "GETUSERLOGINF", usercode, fdate, tdate, "", "", "", "", "", "");
            if (ds1 == null)
            {
        ...
        private void PrintLogAll()
        {
            ...
            DataTable dt = (DataTable)Session["UserLog"];
            //ReportDocument rptLog = new RMGiRPT.R_34_Mgt.rptEntryLogAll();
