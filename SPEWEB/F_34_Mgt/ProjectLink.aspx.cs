    ...
    public partial class ProjectLink : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Store Permission";
        ...
        protected void Load_Project_Combo()
        {
            ...
            string FindProject = "%";
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_MGT", "GETPRJLIST", FindProject, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        private void Get_Receive_Info()
        {
            ...
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_MGT", "GETPRELINK", UserCode, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void lbtnSuplUpdate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tbl1.Rows.Count; i++)
            {
                ...
                bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_MGT", "INSERTUPDATEPROLINK",
        ...
        protected void gvProLinkInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_MGT", "DELETEPROCODE", UserName, BankCode, "", "", "", "", "", "", "", "", "", "", "", "", "");
