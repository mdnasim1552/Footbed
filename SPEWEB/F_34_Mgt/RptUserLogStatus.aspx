<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptUserLogStatus.aspx.cs" Inherits="SPEWEB.F_34_Mgt.RptUserLogStatus" %>
                   ...
                   <asp:GridView ID="gvUserLog" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Entry Type">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvEvent" runat="server"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "eventtype")) %>'
