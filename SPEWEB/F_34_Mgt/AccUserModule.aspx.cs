...
namespace SPEWEB.F_34_Mgt
{
    public partial class AccUserModule : System.Web.UI.Page
    {
        ...
        protected void GetControlAccCode()
        {
            ...
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_MGT", "GETMODULELIST", FindProject, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;

            this.ddlConTrolCode.DataTextField = "modulename";
        ...
        private void GetUserModPer()
        {
            ...
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_MGT", "GETUSERMODULE", UserCode, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void lbtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tbl1.Rows.Count; i++)
            {
                ...
                bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_MGT", "INSERTUPDATEPER", userid, pactcode, mRMRKS, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        protected void gvProLinkInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_MGT", "DELUSERMODULEPER", UserName, Userid, "", "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        protected void lbtnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            string comcod = this.GetCompCode();
            string UserName = this.ddlUserList.SelectedValue.ToString();
            bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_MGT", "DELUSERMODULEPERALL", UserName, "", "", "", "", "", "", "", "", "", "", "", "", "", "");
            if (!result)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "CallMyFunction", "showContentFail('Deleted Fail');", true);
