<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="DataBackup.aspx.cs" Inherits="SPEWEB.F_34_Mgt.DataBackup" %>
                ...
                <div class="col-md-7 col-md-offset-2">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <asp:Button ID="btnBackup" runat="server" CssClass="btn btn-warning " Text="Backup DataBase(Alt+4)" OnClick="btnBackup_Click" />
                        </div>
                    </div>
                </div>
