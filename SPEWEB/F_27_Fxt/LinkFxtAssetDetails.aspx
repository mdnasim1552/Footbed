<%@ Page Title="" Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="LinkFxtAssetDetails.aspx.cs" Inherits="SPEWEB.F_27_Fxt.LinkFxtAssetDetails" %>
                    ...
                    <div class="row">
                        <div class="col-2 col-md-2">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="lblrsirdesc" runat="server" CssClass=" form-control form-control-sm"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlProjectName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProjectName_SelectedIndexChanged" CssClass=" ddlPage chzn-select" TabIndex="6">
                                </asp:DropDownList>
                        ...
                        <div class="col-1 col-md-1 text-center" style="margin-top:20px;">
                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-sm btn-primary" OnClick="LinkButton1_Click">Add</asp:LinkButton>
                        </div>

                        <div class="col-1 col-md-1 text-center" style="margin-top:20px;">
                            <asp:Label ID="lmsg" runat="server" CssClass="btn btn-sm btn-danger" Visible="false"></asp:Label>
                        </div>
                    ...
                    <asp:GridView ID="gvProSlInfo" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText=" User Name">
                                ...
                                <FooterTemplate>
                                    <asp:LinkButton ID="lUpdate" runat="server" CssClass="btn btn-sm btn-danger" OnClick="lUpdate_Click1">Update</asp:LinkButton>
                                </FooterTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Qty">
                                ...
                                <FooterTemplate>
                                    <asp:Label runat="server" ID="lblFqty" Visible="False"></asp:Label>
                                </FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnde" runat="server" OnClick="btnde_click"><span style="color:red"  class="fa fa-trash"></span> </asp:LinkButton>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>
