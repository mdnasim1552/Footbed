<%@ Page Language="C#" MasterPageFile="~/SPE.Master" AutoEventWireup="true" CodeBehind="PurReturnList.aspx.cs" Inherits="SPEWEB.F_10_Procur.PurReturnList" %>
            ...
            <div class="card">
                <div class="card-body" style="min-height: 500px;">
                    <div class="row col-md-12">
                        ...
                        <asp:GridView ID="GvPurReturn" AutoGenerateColumns="False" OnRowDataBound="GvPurReturn_RowDataBound" runat="server" CssClass="table-striped table-hover table-bordered grvContentarea">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Return No">
                                    <ItemTemplate>
                                        <asp:Label ID="lgcPurRetno" runat="server"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "pretmemo")) %>'
                                ...
                                <asp:TemplateField HeaderText="Date">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lgcRetDate" runat="server"
                                            Text='<%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "pretdat")).ToString("dd-MMM-yyyy") %>'
                                ...
                                <asp:TemplateField HeaderText="">
                                        ...
                                        <table style="border: none;">
                                            <tr>
                                                <td style="border: none;">
                                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Center Name" Width="100"></asp:Label>
                                                </td>
                                                <td>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lvgrrno" runat="server"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "centrdesc")) %>'
                                            Width="250px"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Centrid" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lgcCentrid" runat="server"
                                ...
                                <asp:TemplateField HeaderText="Item</br>Count">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvItm" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvVounum" runat="server" Visible="false"
