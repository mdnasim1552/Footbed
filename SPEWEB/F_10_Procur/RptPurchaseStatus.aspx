<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="RptPurchaseStatus.aspx.cs" Inherits="SPEWEB.F_10_Procur.RptPurchaseStatus" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-md-6 pading5px asitCol6">
                                        ...
                                        <asp:DropDownList ID="ddlProjectName" runat="server" style="width:450px" CssClass="chzn-select  ddlPage">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <asp:DropDownList ID="ddlMatCode" runat="server" visible="false" Width="200px" CssClass="chzn-select ddlPage">
                                        </asp:DropDownList>
                                    </div>
                                                    ...
                                                    <asp:TemplateField HeaderText="Material Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lgvMaterials3" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "rsirdesc")) %>'
                                                                Width="170px"></asp:Label></ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Unit ">
                                                        <ItemTemplate>
                                        ...
                                        <div class="col-md-4 pading5px">
                                            <div class="input-group">
                                                <asp:HyperLink ID="lnkCreateMat" runat="server" CssClass="btn btn-warning primaryBtn" Visible="false"
                                                    NavigateUrl="~/F_17_Acc/AccSubCodeBook?InputType=Res" Target="_blank">Create Material</asp:HyperLink>
                                    ...
                                    <fieldset class="scheduler-border fieldset_B">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 pading5px  asitCol3">
                                                    <asp:DropDownList ID="ddlMaterial" runat="server" CssClass=" ddlPage">
                                                    </asp:DropDownList>
                                    ...
                                    <fieldset class="scheduler-border fieldset_B">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 pading5px  asitCol3">
                                                    <asp:DropDownList ID="ddlBillno" runat="server" CssClass="form-control inputTxt">
                                                    </asp:DropDownList>
                                ...
                                <asp:GridView ID="gvPurBilltk" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rate">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lgvAppRate2" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "rate")).ToString("#,##0;(#,##0); ") %>'
                                                    Width="60px"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            <ItemStyle HorizontalAlign="Right" />
                                    ...
                                    <fieldset class="scheduler-border fieldset_B">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 pading5px  asitCol3">
                                                    <asp:DropDownList ID="ddlMaterialscom" runat="server" CssClass="form-control inputTxt">
                                                    </asp:DropDownList>
