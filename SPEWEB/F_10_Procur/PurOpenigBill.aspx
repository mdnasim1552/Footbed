<%@ Page Title="" Language="C#" MasterPageFile="~/SPEMaster.Master" AutoEventWireup="true" CodeBehind="PurOpenigBill.aspx.cs" Inherits="SPEWEB.F_10_Procur.PurOpenigBill" %>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 pading5px ">
                                        <asp:DropDownList ID="ddlSupplier" runat="server" CssClass="form-control inputTxt  chzn-select">
                                        </asp:DropDownList>
