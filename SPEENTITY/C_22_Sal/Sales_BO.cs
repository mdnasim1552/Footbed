    ...
    public class Sales_BO
    {
        ...
        public class DebtorList
        {
            ...
            public DebtorList(string actcode, string custid, string custname, string curcode, double limit, double duesamt, string ssircode, string ssirdesc, double ballimit,
                double proamt, string custname2, string custaddr)
            {
                this.actcode = actcode;
                this.custid = custid;
        ...
        public class ProductList
        {
            ...
            public ProductList(string actcode, string prcod, string prdesc, string batchcode, string batchdesc, double avlablqty, double tmprice, double price,
                bool wastatus, string unit, string prodscode, string taxcode, string ordqty, string promqty, double amount, string prtdesc, double upordqty, double balstkqyt)
            {
                this.actcode = actcode;
                this.prcod = prcod;
                this.prdesc = prdesc;
        ...
        public class EClassGetAllInv
        {
            ...
            public EClassGetAllInv(string centrid, string centrdesc, string custid, string custdesc, string memono, string memono1, string vounum1, string memodat,
                double itmamt, double vat, double invdis, double vatper, double invdisper, string payvounum)
            {
                this.centrid = centrid;
        ...
        public class SalColDues
        {
            ...
            public SalColDues(string comcod, string grp, string centrid, string teamcode, string teamdesc, string teritory, DateTime joindate, string desg, string idcard, double salamt,
                double collamt, double s1, double c1, double d1, double s2, double c2, double d2, double cd2, double s3, double c3, double d3, double cd3,
                double s4, double c4, double d4, double cd4, double s5, double c5, double d5, double cd5,
                double s6, double c6, double d6, double cd6, double s7, double c7, double d7, double cd7,
                double s8, double c8, double d8, double cd8, double s9, double c9, double d9, double cd9, double s10, double c10, double d10, double cd10, double s11, double c11, double d11, double cd11, double s12, double c12, double d12, double cd12)
            {
        ...
        [Serializable]
        public class RptIndProStockModel
        {
