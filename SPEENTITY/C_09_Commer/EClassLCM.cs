...
namespace SPEENTITY.C_09_Commer
{
    ...
    public class EClassLCStatus
    {
        ...
        public double lcval { get; set; }
        public double euroval { get; set; }
        ...
        public string lpaytcode { get; set; }
        public string lpaytrm { get; set; }
        public string befnam { get; set; }
        ...
        public string dtrmcod { get; set; }
        public string deltrm { get; set; }
        public string delmodcod { get; set; }
        ...
        public double totlpaymnt { get; set; }
        public string currencydesc { get; set; }
        public double lcopnamt { get; set; }

        public EClassLCStatus() { }
        public EClassLCStatus(string grp, string actcode, string actdesc, string rescod, string resdesc, double ordrqty, double rate, double lcamt, double lcval, string lcdate, string shipdate,
                string shipardate, string deldate, string expdate, string rcvdate, string lcstatus, string fileno, string lpaytcode, string lpaytrm, string befnam, string blno,
            string bldat, string etadat, string beno, string bedat, string docpos, string cnf, string paydat, string dtrmcod, string deltrm, string delmodcod, string delmod, string remarks, string unit)
        {
            this.grp = grp;
            this.actcode = actcode;
            this.actdesc = actdesc;
            ...
            this.fileno = fileno;
            this.lpaytcode = lpaytcode;
            this.lpaytrm = lpaytrm;
            this.befnam = befnam;
            this.blno = blno;
            this.bldat = bldat;
            this.etadat = etadat;
            ...
            this.cnf = cnf;
            this.paydat = paydat;
            this.dtrmcod = dtrmcod;
            this.deltrm = deltrm;
            this.delmodcod = delmodcod;
            this.delmod = delmod;
