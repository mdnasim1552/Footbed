...
namespace SPEENTITY.C_47_Kpi
{
    ...
    public class EClassEmployeeMonEva
    {
        ...
        public EClassEmployeeMonEva(string ymonid, string yearmon, double tamt1, double tamt2, double tamt3, double tamt4, double tamt5, double tamt6, double amt1,
                double amt2, double amt3, double amt4, double amt5, double amt6, double tper, double tmark, string gpa, double Target, double Actual, double avgmark) 
        {
            this.ymonid = ymonid;
