...
namespace SPELIB
{
    ...
    public class ProcessAccess
    {
        ...
        public SqlDataReader GetSqlReader(string comCode, string SQLprocName, string CallType, string mDesc1, string mDesc2,
...
string mDesc3 = "", string mDesc4 = "", string mDesc5 = "", string mDesc6 = "", string mDesc7 = "", string mDesc8 = "", string mDesc9 = "")
     ...
     string mDesc3 = "", string mDesc4 = "", string mDesc5 = "", string mDesc6 = "", string mDesc7 = "", string mDesc8 = "", string mDesc9 = "", string mDesc10 = "", string mDesc11 = "")
        ...
        public DataSet GetTransInfoNew01(string comCode, string SQLprocName, string CallType, 
                  string mDesc1 = "",  string mDesc2 = "", string mDesc3 = "", string mDesc4 = "", string mDesc5 = "", string mDesc6 = "", string mDesc7 = "", string mDesc8 = "",
                  string mDesc9 = "",  string mDesc10 = "", string mDesc11 = "", string mDesc12 = "", string mDesc13 = "", string mDesc14 = "", string mDesc15 = "",
                  string mDesc16 = "", string mDesc17 = "", string mDesc18 = "", string mDesc19 = "", string mDesc20 = "", string @userid = "")
        {
 ...
 string mDesc1 = "", string mDesc2 = "", string mDesc3 = "", string mDesc4 = "", string mDesc5 = "", string mDesc6 = "",
        ...
        public bool UpdateTransInfo1(string comCode, string SQLprocName, string CallType,
           string mDesc1 = "", string mDesc2 = "", string mDesc3 = "", string mDesc4 = "", string mDesc5 = "", string mDesc6 = "",
           string mDesc7 = "", string mDesc8 = "", string mDesc9 = "", string mDesc10 = "", string mDesc11 = "", string mDesc12 = "",
           string mDesc13 = "", string mDesc14 = "", string mDesc15 = "", string mDesc16 = "", string mDesc17 = "", string mDesc18 = "",
          string mDesc19 = "", string mDesc20 = "", string mDesc21 = "", string mDesc22 = "", string mDesc23 = "", string mDesc24 = "",
          string mDesc25 = "", string mDesc26 = "", string mDesc27 = "", string mDesc28 = "", string mDesc29 = "", string mUserID = "")
        {
            try
            {
                this.ClearErrors();
        ...
        public bool UpdateTransInfo01(string comCode, string SQLprocName, string CallType,
           ...
           string mDesc37 = "", string mDesc38 = "", string mDesc39 = "", string mDesc40 = "", string mDesc41 = "", string mDesc42 = "", string mUserID="")
        {
            try
            {
                this.ClearErrors();
        ...
        public bool UpdateTransInfoHRSal(string comCode, string SQLprocName, string CallType,
          ...
          string mDesc79 = "", string mDesc80 = "", string @UserID = "")
        {
            try
            {
                this.ClearErrors();
  ...
  string mDesc7, string mDesc8, string mDesc9, string mDesc10, string mDesc11, string mDesc12,
  string mDesc13, string mDesc14, string mDesc15, string mDesc16, string mDesc17, string mDesc18,
 string mDesc19, string mDesc20, string mDesc21, string mDesc22, string mDesc23, string mDesc24, string mDesc25, string mUserID)
        {
            try
            {
                this.ClearErrors();
        ...
        public bool InsertClientPhoto(string comCode, string empid, byte[] image, byte[] sign)
        {
            try
            {
                ...
                cmd.CommandText = "Insert into dbo_hrm.hrimginf (comcod, empid,  empimage, empsign) values (@Comp1, @Desc1, @Desc2, @Desc3)";
        ...
        public bool UpdateClientPhoto(string comCode, string empid, byte[] image, byte[] sign)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update dbo_hrm.hrimginf set empimage=@Desc2, empsign=@Desc3 where comcod=@Comp1 and empid=@Desc1";
                cmd.Parameters.AddWithValue("@Comp1", comCode);
                cmd.Parameters.AddWithValue("@Desc1", empid);
                cmd.Parameters.AddWithValue("@Desc2", image);
                cmd.Parameters.AddWithValue("@Desc3", sign);
        ...
        public bool UpdateClientOnlyPhoto(string comCode, string empid, byte[] image)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update dbo_hrm.hrimginf set empimage=@Desc2 where comcod=@Comp1 and empid=@Desc1";
                cmd.Parameters.AddWithValue("@Comp1", comCode);
                cmd.Parameters.AddWithValue("@Desc1", empid);
                cmd.Parameters.AddWithValue("@Desc2", image);
                bool _result = _dataAccess.ExecuteCommand(cmd);
        ...
        public bool UpdateClientOnlySign(string comCode, string empid, byte[] sign)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update dbo_hrm.hrimginf set empsign=@Desc2 where comcod=@Comp1 and empid=@Desc1";
                cmd.Parameters.AddWithValue("@Comp1", comCode);
                cmd.Parameters.AddWithValue("@Desc1", empid);
        ...
        public bool InsertUserPhoto(string comCode, string empid, byte[] image)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Insert into usrimginf (comcod, usrid,  usrimg) values (@Comp1, @Desc1, @Desc2)";
                cmd.Parameters.AddWithValue("@Comp1", comCode);
                cmd.Parameters.AddWithValue("@Desc1", empid);
                cmd.Parameters.AddWithValue("@Desc2", image);
                bool _result = _dataAccess.ExecuteCommand(cmd);
        ...
        public bool UpdateUserPhoto(string comCode, string empid, byte[] image)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update usrimginf set usrimg=@Desc2 where comcod=@Comp1 and usrid=@Desc1";
                cmd.Parameters.AddWithValue("@Comp1", comCode);
                cmd.Parameters.AddWithValue("@Desc1", empid);
                cmd.Parameters.AddWithValue("@Desc2", image);
                bool _result = _dataAccess.ExecuteCommand(cmd);
    ...
    string mDesc13, string mDesc14, string mUserID)
        ...
        public bool SysExpiryUpdate(string comCode, DateTime date)
        {
            try
            {
                ...
                string connectionString = @"Server=123.200.23.58\MSSQL2K14;Database=PINBOARDDB;uid=sa;pwd=@ptl*zaq1`123$;";
        ...
        public bool InsertTicket(string comcod, string txtTicketDesc, string ticketType, string taskProgress, string priority, string createTask, string username, string txtRemarks, string proposedUser, string compUser)
        {
            try
            {
                string connectionString = @"Server=123.200.23.58\MSSQL2K14;Database=PINBOARDDB;uid=sa;pwd=@ptl*zaq1`123$;";
                ...
                try
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        SqlCommand command = new SqlCommand(" insert into tbl_tasks (comcod,taskdesc,tasktype,taskprogress, taskpriority, createtask ,createuser, remarks, proposeduser, comuser) " +
                            "values ('" + comcod.Trim() + "', '" + txtTicketDesc.Trim() + "', '" + ticketType.Trim() + "', '" + taskProgress.Trim() + "', '" + priority.Trim() + "', '" + createTask.Trim() + "', '" + username.Trim() + "', '" + txtRemarks.Trim() + "','" + proposedUser.Trim() + "','" + compUser + "')", connection);
                        connection.Open();
                        command.ExecuteNonQuery();
                        connection.Close();
                    }
