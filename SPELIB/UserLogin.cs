   ...
   public class UserLogin
    {
       ...
       public DataSet GetNameAdd()
       {
           ...
           string cmd = "select comcod, comnam, comsnam,  comadd1+'<br />'+comadd2+' '+comadd3 as comadd, comadd1,comadd2, comadd3, comadd4, compcod, combranch, slnum, comaddf from compinf order by slnum, comcod asc";
           DataSet ds = da.GetDataSet(cmd);
           return ds;
        }
       public DataSet GetCompanyAndAdd()
       {
           string cmd = "select comcod, comnam, comsnam,  comadd1+'<br />'+comadd2+' '+comadd3 as comadd, comadd1,comadd2, comadd3, comadd4, compcod, slnum  from compinf where compcod IS Null order by slnum, comcod asc";
           DataSet ds = da.GetDataSet(cmd);
           return ds;
